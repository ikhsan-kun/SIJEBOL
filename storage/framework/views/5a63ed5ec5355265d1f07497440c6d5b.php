<?php $__env->startSection('title', 'Profil Admin - SI JEBOL'); ?>
...
<style>
    ...
    .header-title { font-size: 2rem; font-weight: 800; margin: 0 0 4px 0; letter-spacing: -0.5px; }
    ...
    .info-content { flex: 1; }
    .info-label { font-size: 0.8rem; font-weight: 700; color: var(--text-muted); text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 4px; }
...
<div class="page-header">
    <div class="header-content">
        ...
        <?php else: ?>
            <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode(auth()->user()->name)); ?>&background=f59e0b&color=ffffff&bold=true&size=200" alt="Avatar" class="profile-avatar-large">
        <?php endif; ?>
        <div>
            <h1 class="header-title"><?php echo e(auth()->user()->name); ?></h1>
            <p class="header-subtitle">
                <i data-lucide="shield" style="width: 16px;"></i> <?php echo e(auth()->user()->jabatan ?? 'Admin Pusat'); ?>

            </p>
        </div>
    </div>
    <div class="header-actions">
        <a href="<?php echo e(route('admin.profil.edit')); ?>" class="btn btn-warning">
            <i data-lucide="edit-3" style="width: 18px;"></i> Ubah Profil
        </a>
        <a href="<?php echo e(route('admin.profil.password')); ?>" class="btn btn-light-outline">
            ...
            <div class="info-list">
                ...
                <div class="info-item">
                    ...
                    <div class="info-content">
                        ...
                        <div class="info-value"><?php echo e(auth()->user()->jabatan ?? 'Admin Pusat'); ?></div>
                    </div>
                </div>
                ...
                <div class="info-item">
                    ...
                    <div class="info-content">
                        ...
                        <div class="info-value"><?php echo e(auth()->user()->alamat ?? 'Jl. Ki Gede Sebayu No. 12, Kota Tegal, Jawa Tengah 52122'); ?></div>
                    </div>
                </div>
        ...
        <div class="panel-box">
            ...
            <div class="stat-card">
                ...
                <div class="stat-text">
                    ...
                    <div class="stat-val"><?php echo e(auth()->user()->role ?? 'Admin'); ?></div>
                    <div class="stat-desc">Akses sebagai administrator</div>
                </div>
            </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-text">
                    ...
                    <div class="stat-desc" title="<?php echo e($lastLogin->user_agent ?? ''); ?>">Melalui <?php echo e($loginDevice); ?></div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\jeboll\resources\views/admin/profil.blade.php ENDPATH**/ ?>