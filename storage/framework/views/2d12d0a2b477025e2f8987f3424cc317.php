<?php $__env->startSection('title', 'Dashboard Cabang'); ?>
...
<div class="custom-hero">
    <div class="hero-content">
        ...
        ?>
        <h1 class="hero-title">Selamat <?php echo e($greeting); ?>, <span><?php echo e(explode(' ', auth()->user()->name ?? 'Petugas')[0]); ?>!</span> 👋</h1>
            ...
            <div style="display: flex; gap: 16px; align-items: center; margin-bottom: 20px;">
                ...
                <div>
                    ...
                    <p style="margin: 0; font-size: 0.85rem; opacity: 0.9; display: flex; align-items: center; gap: 4px;">
                        <i data-lucide="map-pin" style="width: 14px; height: 14px;"></i> <?php echo e($nextSchedule->kecamatan ?? 'Kota Tegal'); ?>
...
<div class="dashboard-grid">
    <div class="stat-card">
        ...
        <div class="stat-info">
            ...
            <span class="stat-value"><?php echo e(number_format($sekolahCount)); ?></span>
        </div>
    </div>
    ...
    <div class="stat-card">
        ...
        <div class="stat-info">
            ...
            <span class="stat-value"><?php echo e(number_format($totalSiswa)); ?></span>
        </div>
    </div>
    ...
    <div class="stat-card">
        ...
        <div class="stat-info">
            ...
            <span class="stat-value"><?php echo e(number_format($pengajuanCount)); ?></span>
        </div>
    </div>
    ...
    <div class="stat-card">
        ...
        <div class="stat-info">
            ...
            <span class="stat-value"><?php echo e(number_format($selesaiCount)); ?></span>
        </div>
    </div>
</div>
...
<div class="main-grid">
    ...
    <div class="panel-box">
        ...
        <div style="display: flex; flex-direction: column; gap: 20px; padding: 10px 0;">
            <?php $sebaranTotal = $sebaranLayanan->sum('total'); ?>
            <?php $__empty_1 = true; $__currentLoopData = $sebaranLayanan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $layanan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div style="display: flex; flex-direction: column; gap: 8px;">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <span style="font-weight: 700; color: var(--text-main); font-size: 0.95rem;"><?php echo e($layanan->jenis_layanan); ?></span>
                        <span style="font-weight: 800; color: var(--text-main); font-size: 0.95rem;"><?php echo e($layanan->total); ?> <span style="font-weight: 500; color: var(--text-muted); font-size: 0.8rem;">(<?php echo e($percent); ?>%)</span></span>
                    </div>
                    <div style="height: 12px; background: #e2e8f0; border-radius: 99px; overflow: hidden; position: relative;">
                        <div style="width: <?php echo e($percent); ?>%; height: 100%; background: <?php echo e($bgGradient); ?>; border-radius: 99px; box-shadow: 0 0 10px <?php echo e($glowColor); ?>; transition: width 0.8s cubic-bezier(0.4, 0, 0.2, 1);"></div>
                    </div>
                </div>
...
<div class="main-grid">
    <div class="panel-box">
        <div class="panel-header">
            ...
            <a href="<?php echo e(route('cabang.monitoring') ?? '#'); ?>" style="color: var(--primary); text-decoration: none; font-size: 0.9rem; font-weight: 600;">Lihat Semua</a>
        </div>
        <div style="overflow-x: auto;">
            <table style="width: 100%; border-collapse: separate; border-spacing: 0 12px; text-align: left;">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $aktivitas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $akt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr style="background: #f8fafc; border-radius: 8px;">
                        <td style="padding: 16px 20px; font-weight: 600; color: var(--text-main); border-radius: 12px 0 0 12px;"><?php echo e($akt->nomor_tiket); ?></td>
                        <td style="padding: 16px 20px; font-weight: 600;"><?php echo e($akt->jenis_layanan); ?></td>
                        <td style="padding: 16px 20px; color: var(--text-muted);"><?php echo e(\Carbon\Carbon::parse($akt->tanggal_pengajuan)->format('d M Y')); ?></td>
                        <td style="padding: 16px 20px; border-radius: 0 12px 12px 0;">
                            <span style="padding: 6px 12px; border-radius: 8px; font-size: 0.8rem; font-weight: 700;
                                <?php if($akt->status == 'selesai'): ?> background: #dcfce3; color: #166534;
                                <?php elseif($akt->status == 'pending' || $akt->status == 'menunggu_verifikasi'): ?> background: #fef3c7; color: #b45309;
                                <?php else: ?> background: #eff6ff; color: #1d4ed8; <?php endif; ?>
                            ">
                                <?php echo e(strtoupper(str_replace('_', ' ', $akt->status))); ?>
    ...
    <div class="panel-box">
        ...
        <div style="display: flex; flex-direction: column; gap: 16px;">
            <?php $__empty_1 = true; $__currentLoopData = $upcomingJadwals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jadwal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div style="display: flex; gap: 16px; align-items: center; padding: 16px; background: #f8fafc; border-radius: 12px; border: 1px solid #f1f5f9;">
                <div style="background: #eff6ff; color: var(--primary); width: 48px; height: 48px; border-radius: 12px; display: flex; flex-direction: column; align-items: center; justify-content: center; flex-shrink: 0;">
                    <span style="font-weight: 800; font-size: 1.2rem; line-height: 1;"><?php echo e(\Carbon\Carbon::parse($jadwal->tanggal_pelayanan)->format('d')); ?></span>
                    <span style="font-size: 0.65rem; font-weight: 700; text-transform: uppercase;"><?php echo e(\Carbon\Carbon::parse($jadwal->tanggal_pelayanan)->format('M')); ?></span>
                </div>
                <div style="flex-grow: 1;">
                    <h4 style="margin: 0 0 4px; font-size: 0.95rem; font-weight: 700;"><?php echo e(preg_replace('/\s*\(.*?\)/', '', $jadwal->lokasi)); ?></h4>
                    <p style="margin: 0; font-size: 0.8rem; color: var(--text-muted); display: flex; align-items: center; gap: 4px;">
                        <i data-lucide="map-pin" style="width: 12px; height: 12px;"></i> <?php echo e($jadwal->kecamatan ?? 'Tegal'); ?>
...
<?php echo $__env->make('layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\jeboll\resources\views/cabang/dashboard.blade.php ENDPATH**/ ?>