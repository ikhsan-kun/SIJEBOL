...
<div class="dashboard-grid">
    ...
    <div class="stat-card">
        ...
        <div class="stat-info">
            ...
            <span class="stat-value"><?php echo e(number_format($siswaTerlayani)); ?></span>
        </div>
    </div>
</div>
            ...
            <table style="width: 100%; border-collapse: separate; border-spacing: 0 12px; text-align: left; min-width: 600px;">
                ...
                <tbody>
                    ...
                    <tr style="background: #f8fafc; border-radius: 8px;">
                        <td style="padding: 16px 20px; font-weight: 600; color: var(--text-main); border-radius: 12px 0 0 12px; white-space: nowrap;"><?php echo e($akt->nomor_tiket); ?></td>
                        <td style="padding: 16px 20px; font-weight: 600; white-space: nowrap;">
                            <div style="display: flex; align-items: center; gap: 8px;">
                                <div style="width: 8px; height: 8px; border-radius: 50%; background: var(--primary);"></div>
                                <?php echo e($akt->jenis_layanan); ?>

                            </div>
                        </td>
                        <td style="padding: 16px 20px; color: var(--text-muted); white-space: nowrap;"><?php echo e(\Carbon\Carbon::parse($akt->tanggal_pengajuan)->format('d M Y')); ?></td>
                        <td style="padding: 16px 20px; border-radius: 0 12px 12px 0; white-space: nowrap;">
                            <span style="padding: 6px 14px; border-radius: 20px; font-size: 0.75rem; font-weight: 700; border: 1px solid transparent; display: inline-flex; align-items: center; gap: 6px;
                                <?php if($akt->status == 'selesai'): ?> background: #dcfce3; color: #166534; border-color: #bbf7d0;
                                <?php elseif($akt->status == 'pending' || $akt->status == 'menunggu_verifikasi'): ?> background: #fef3c7; color: #b45309; border-color: #fde68a;
                                <?php else: ?> background: #eff6ff; color: #1d4ed8; border-color: #bfdbfe; <?php endif; ?>
                            ">
