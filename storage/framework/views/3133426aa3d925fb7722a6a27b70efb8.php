...
<div class="page-header">
                <div class="header-content">
                    <div class="profile-avatar-large">
                        <?php if(auth()->user()->foto_profil ?? auth()->user()->profile_photo_path): ?>
                            <img src="<?php echo e(asset('storage/' . (auth()->user()->foto_profil ?? auth()->user()->profile_photo_path))); ?>" alt="Avatar" style="width:100%;height:100%;object-fit:cover;border-radius:50%;">
                        <?php else: ?>
                    ...
                    <div>
                        <h1 class="header-title"><?php echo e(auth()->user()->nama ?? auth()->user()->name ?? 'Pengguna'); ?></h1>
                ...
                <div class="header-actions">
                    <a href="<?php echo e(route('masyarakat.settings')); ?>" class="btn btn-warning">
                        <i data-lucide="edit-3" style="width: 18px;"></i> Ubah Profil
                    </a>
                    <a href="<?php echo e(route('masyarakat.settings.password')); ?>" class="btn btn-light-outline">
                        ...
                        <div class="info-list">
                            <div class="info-item">
                                ...
                                <div class="info-content">
                                    ...
                                    <div class="info-value"><?php echo e(auth()->user()->nik); ?></div>
                                </div>
                            </div>
                            ...
                            <div class="info-item">
                                ...
                                <div class="info-content">
                                    ...
                                    <div class="info-value"><?php echo e(auth()->user()->nama ?? auth()->user()->name ?? '-'); ?></div>
                                </div>
                            </div>
                            ...
                            <div class="info-item">
                                ...
                                <div class="info-content">
                                    ...
                                    <div class="info-value"><?php echo e(auth()->user()->no_hp ?? auth()->user()->phone ?? '-'); ?></div>
                                </div>
                            </div>
                            ...
                            <div class="info-item">
                                ...
                                <div class="info-content">
                                    ...
                                    <div class="info-value"><?php echo e(auth()->user()->kecamatan ?? '-'); ?></div>
                                </div>
                            </div>
                            ...
                            <div class="info-item">
                                ...
                                <div class="info-content">
                                    ...
                                    <div class="info-value"><?php echo e(auth()->user()->alamat ?? auth()->user()->alamat_lengkap ?? '-'); ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel-box">
                        ...
                        <div class="stat-card">
                            ...
                            <div class="stat-text">
                                ...
                                <div class="stat-val" style="font-size: 0.95rem;"><?php echo e(auth()->user()->created_at ? auth()->user()->created_at->translatedFormat('d M Y') : '-'); ?></div>
...
<?php echo $__env->make('layouts.masyarakat', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\jeboll\resources\views/masyarakat/profile.blade.php ENDPATH**/ ?>