...
<div class="stats-container">
    <div class="stat-card">
        ...
        <div class="stat-content">
            ...
            <p class="stat-value"><?php echo e($schools->count()); ?></p>
    ...
    <div class="stat-card">
        ...
        <div class="stat-content">
            ...
            <p class="stat-value"><?php echo e(number_format($schools->sum('jumlah_siswa'))); ?></p>
    ...
    <div class="stat-card">
        ...
        <div class="stat-content">
            ...
            <p class="stat-value"><?php echo e(number_format($schools->sum('pengajuan_selesai'))); ?></p>
    ...
    <div class="stat-card">
        ...
        <div class="stat-content">
            ...
            <p class="stat-value"><?php echo e($schools->where('status_jempol', 'Dijadwalkan')->count()); ?></p>
...
<div class="filter-card">
    <form class="filter-form" action="<?php echo e(route('cabang.sekolah')); ?>" method="GET">
        <div class="filter-group" style="flex: 2;">
            <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari sekolah, npsn..." class="filter-input">
        </div>
        <div class="filter-group">
            <input type="date" name="tanggal" value="<?php echo e(request('tanggal')); ?>" class="filter-input">
        </div>
        <div class="filter-group">
            <select name="status" class="filter-input">
                <option value="">Semua Status</option>
                <option value="Belum Dijadwalkan" <?php echo e(request('status') == 'Belum Dijadwalkan' ? 'selected' : ''); ?>>Belum Dijadwalkan</option>
        ...
        <div style="display: flex; gap: 12px;">
            ...
            <?php if(request('search') || request('status') || request('tanggal')): ?>
            <a href="<?php echo e(route('cabang.sekolah')); ?>" class="btn-reset">
...
<div class="table-card">
    <div class="table-responsive">
        <table class="data-table">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $schools; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $school): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    <td style="font-weight: 700; color: var(--text-muted);"><?php echo e($schools->firstItem() + $i); ?></td>
                    <td>
                        <div style="font-weight: 700; color: var(--primary); margin-bottom: 4px;"><?php echo e($school->nama_sekolah); ?></div>
                        <div style="display: flex; gap: 6px;">
                            <span style="background: #f1f5f9; padding: 2px 6px; border-radius: 4px; font-size: 0.7rem; font-weight: 600;"><?php echo e($school->tingkat); ?></span>
                            <span style="background: #eff6ff; color: #2563eb; padding: 2px 6px; border-radius: 4px; font-size: 0.7rem; font-weight: 600;">Fokus: <?php echo e($school->fokus_layanan ?? 'KTP-el'); ?></span>
                        </div>
                    </td>
                    <td><span style="font-family: monospace; background: #f8fafc; padding: 4px 8px; border-radius: 6px; font-size: 0.85rem;"><?php echo e($school->npsn ?? '-'); ?></span></td>
                    <td><span style="font-size: 0.85rem; color: var(--text-muted);"><?php echo e($school->alamat ?? '-'); ?></span></td>
                    <td>
                        <div style="font-weight: 600; font-size: 0.85rem;"><?php echo e($school->kecamatan); ?></div>
                        <?php if($school->kelurahan): ?>
                        <div style="font-size: 0.75rem; color: var(--text-muted);"><?php echo e($school->kelurahan); ?></div>
                        <?php endif; ?>
                    </td>
                    <td>
                        <div style="font-weight: 700;"><?php echo e(number_format($school->pengajuan_selesai)); ?> <span style="color: var(--text-muted); font-weight: 500; font-size: 0.75rem;">/ <?php echo e(number_format($school->jumlah_siswa)); ?></span></div>
                    </td>
                    <td>
                        <?php if($school->status_jempol == 'Sudah' || $school->status_jempol == 'Selesai'): ?>
                            <span class="status-badge badge-success"><i data-lucide="check-circle" style="width: 12px; height: 12px;"></i> Selesai</span>
                        <?php elseif($school->status_jempol == 'Dijadwalkan'): ?>
                        ...
                        <?php if(isset($school->jadwal_terbaru) && $school->status_jempol != 'Belum Dijadwalkan'): ?>
                            <div style="font-size: 0.7rem; color: var(--text-muted); margin-top: 4px; font-weight: 600;">
                                <?php echo e(\Carbon\Carbon::parse($school->jadwal_terbaru->tanggal)->format('d M Y')); ?>
                    ...
                    <td>
                        <div style="display: flex; flex-wrap: wrap; gap: 6px;">
                            <button onclick="openDetailModal(<?php echo e($school->id); ?>)" class="btn-action" title="Detail">
                                <i data-lucide="eye" style="width: 14px; height: 14px;"></i>
                            </button>
                            <a href="<?php echo e(route('cabang.sekolah.ajukan_jadwal', ['school' => $school->nama_sekolah])); ?>" class="btn-action primary" title="Jadwal">
                                <i data-lucide="calendar-plus" style="width: 14px; height: 14px;"></i>
                            </a>
                            <button onclick="openEditModal(<?php echo e($school->id); ?>, '<?php echo e(addslashes($school->nama_sekolah)); ?>', '<?php echo e(addslashes($school->npsn ?? '')); ?>', '<?php echo e(addslashes($school->alamat ?? '')); ?>', <?php echo e($school->jumlah_siswa); ?>, '<?php echo e($school->fokus_layanan ?? 'KTP-el'); ?>', '<?php echo e($school->tingkat); ?>')" class="btn-action" title="Edit">
                                <i data-lucide="edit" style="width: 14px; height: 14px;"></i>
                            </button>
                            <form action="<?php echo e(route('cabang.sekolah.destroy', $school->id)); ?>" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data sekolah ini?');" style="display: inline;">
                                <?php echo csrf_field(); ?>
        ...
        <div style="padding: 16px 24px; border-top: 1px solid #e2e8f0; display: flex; justify-content: flex-end;">
            <?php echo e($schools->links('vendor.pagination.tailwind')); ?>
...
<div class="modal-overlay" id="modalSekolah">
    <div class="modal-container">
        ...
        <form action="<?php echo e(route('cabang.sekolah.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                    <div class="form-group">
                        ...
                        <select name="kecamatan" required class="form-control">
                            ...
                            <option value="Margadana" <?php echo e(auth()->user()->kecamatan == 'Margadana' ? 'selected' : ''); ?>>Kecamatan Margadana</option>
                            <option value="Tegal Barat" <?php echo e(auth()->user()->kecamatan == 'Tegal Barat' ? 'selected' : ''); ?>>Kecamatan Tegal Barat</option>
                            <option value="Tegal Selatan" <?php echo e(auth()->user()->kecamatan == 'Tegal Selatan' ? 'selected' : ''); ?>>Kecamatan Tegal Selatan</option>
                            <option value="Tegal Timur" <?php echo e(auth()->user()->kecamatan == 'Tegal Timur' ? 'selected' : ''); ?>>Kecamatan Tegal Timur</option>
                        </select>
                    </div>
                    <div class="form-group">
...
<script>
    ...
    const sekolahData = {
        ...
        <?php echo e($school->id); ?>: {
            nama: <?php echo json_encode($school->nama_sekolah, 15, 512) ?>,
            tingkat: <?php echo json_encode($school->tingkat, 15, 512) ?>,
            npsn: <?php echo json_encode($school->npsn ?? '-', 15, 512) ?>,
            alamat: <?php echo json_encode($school->alamat ?? '-', 15, 512) ?>,
            kecamatan: <?php echo json_encode($school->kecamatan, 15, 512) ?>,
            terlayani: <?php echo e($school->pengajuan_selesai ?? 0); ?>,
            siswa: <?php echo e($school->jumlah_siswa ?? 0); ?>,
            percent: <?php echo e($percent); ?>,
            status_jempol: <?php echo json_encode($school->status_jempol, 15, 512) ?>,
            jadwal: <?php echo json_encode($jadwal_terbaru, 15, 512) ?>,
            fokus_layanan: <?php echo json_encode($school->fokus_layanan ?? 'KTP-el', 15, 512) ?>
        },
...
<?php echo $__env->make('layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\jeboll\resources\views/cabang/sekolah.blade.php ENDPATH**/ ?>