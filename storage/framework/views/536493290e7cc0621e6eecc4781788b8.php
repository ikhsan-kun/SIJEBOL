...
<div class="page-header">
                ...
                <div class="header-actions">
                    <a href="<?php echo e(route('masyarakat.profile')); ?>" class="btn btn-light-outline">
            ...
            <div class="panel-box">
                ...
                <form action="<?php echo e(route('masyarakat.settings.update')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-section">
                        ...
                        <div class="avatar-upload-container">
                            <?php if(auth()->user()->foto_profil ?? auth()->user()->profile_photo_path): ?>
                                <img src="<?php echo e(asset('storage/' . (auth()->user()->foto_profil ?? auth()->user()->profile_photo_path))); ?>" alt="Avatar" class="avatar-preview" id="avatar_preview">
                            <?php else: ?>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="<?php echo e(old('name', auth()->user()->nama ?? auth()->user()->name)); ?>" class="form-control" readonly style="background: #f8fafc; color: #94a3b8; cursor: not-allowed;" title="Nama tidak dapat diubah">
                            </div>

                            <div class="form-group">
                                <label class="form-label">NIK / Username</label>
                                <input type="text" value="<?php echo e(auth()->user()->nik ?? auth()->user()->username); ?>" class="form-control" disabled title="NIK tidak dapat diubah">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" value="<?php echo e(old('phone', auth()->user()->telepon ?? auth()->user()->no_hp)); ?>" class="form-control">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <select name="kecamatan" class="form-control">
                                <option value="" disabled <?php echo e(empty(auth()->user()->kecamatan) ? 'selected' : ''); ?>>Pilih Kecamatan Domisili</option>
                                <option value="Kecamatan Tegal Barat" <?php echo e(auth()->user()->kecamatan == 'Kecamatan Tegal Barat' ? 'selected' : ''); ?>>Kecamatan Tegal Barat</option>
                                <option value="Kecamatan Tegal Timur" <?php echo e(auth()->user()->kecamatan == 'Kecamatan Tegal Timur' ? 'selected' : ''); ?>>Kecamatan Tegal Timur</option>
                                <option value="Kecamatan Tegal Selatan" <?php echo e(auth()->user()->kecamatan == 'Kecamatan Tegal Selatan' ? 'selected' : ''); ?>>Kecamatan Tegal Selatan</option>
                                <option value="Kecamatan Margadana" <?php echo e(auth()->user()->kecamatan == 'Kecamatan Margadana' ? 'selected' : ''); ?>>Kecamatan Margadana</option>
                            </select>
                        </div>
                        
                        <div class="form-group">
                            <label class="form-label">Alamat Lengkap</label>
                            <textarea name="alamat" class="form-control" rows="3"><?php echo e(auth()->user()->alamat ?? ''); ?></textarea>
                    ...
                    <div class="form-actions">
                        <a href="<?php echo e(route('masyarakat.profile')); ?>" class="btn btn-outline" style="border: 1px solid #cbd5e1; color: var(--text-main); background: white;">Batal</a>
...
<?php echo $__env->make('layouts.masyarakat', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\jeboll\resources\views/masyarakat/settings.blade.php ENDPATH**/ ?>