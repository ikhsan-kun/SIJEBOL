...
<div class="page-wrap">
    ...
    <form action="<?php echo e(route('register')); ?>" method="POST" id="regForm" autocomplete="off">
        <?php echo csrf_field(); ?>
        ...
        <div id="step1">
            ...
            <div class="field-group">
                ...
                <div class="input-wrap">
                    ...
                    <input class="field-input" type="text" name="name" value="<?php echo e(old('name')); ?>" placeholder="Masukkan nama lengkap" required>
                </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="field-group">
                ...
                <div class="input-wrap">
                    ...
                    <input class="field-input" type="text" name="nik" value="<?php echo e(old('nik')); ?>" placeholder="16 digit angka NIK" maxlength="16" required oninput="this.value=this.value.replace(/[^0-9]/g,'')">
                </div>
                <?php $__errorArgs = ['nik'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
            ...
            <div class="field-row">
                <div>
                    ...
                    <div class="input-wrap">
                        ...
                        <input class="field-input" type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="contoh@gmail.com" required autocomplete="off">
                    </div>
                    <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="ferr" style="font-size:0.7rem;"><?php echo e($message); ?></div><?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                </div>
                <div>
                    ...
                    <div class="input-wrap">
                        ...
                        <input class="field-input" type="tel" name="phone" value="<?php echo e(old('phone')); ?>" placeholder="08xxxxxxxxxx" required oninput="this.value=this.value.replace(/[^0-9]/g,'')" minlength="10" maxlength="13">
                    </div>
            ...
            <div class="field-group">
                ...
                <div class="input-wrap">
                    ...
                    <select class="field-input" name="tipe_pendaftar" id="tipePendaftar" style="padding-right: 24px; width: 100%; border: none; background: transparent; outline: none; cursor: pointer;" onchange="toggleTipePendaftar()" required>
                        <option value="kecamatan" <?php echo e(old('tipe_pendaftar') == 'kecamatan' ? 'selected' : ''); ?>>Warga Umum / Kecamatan</option>
                        <option value="sekolah" <?php echo e(old('tipe_pendaftar') == 'sekolah' ? 'selected' : ''); ?>>Pendaftar Sekolah / Instansi Pendidikan</option>
                    </select>
                </div>
                <?php $__errorArgs = ['tipe_pendaftar'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="ferr"><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="field-group" id="fieldKecamatan" style="display: <?php echo e(old('tipe_pendaftar', 'kecamatan') == 'kecamatan' ? 'block' : 'none'); ?>;">
                ...
                <div class="input-wrap" style="position: relative; overflow: visible !important;">
                    ...
                    <input class="field-input" type="text" name="kecamatan" id="kecamatanInput" value="<?php echo e(old('kecamatan')); ?>" placeholder="Masukkan atau pilih kecamatan asal" autocomplete="off" onfocus="showKecamatanSuggestions()" oninput="filterKecamatanSuggestions()">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="field-group" id="fieldSekolah" style="display: <?php echo e(old('tipe_pendaftar') == 'sekolah' ? 'block' : 'none'); ?>;">
                <label class="field-label">Nama Sekolah</label>
                <div class="input-wrap" style="position: relative; overflow: visible !important;">
                    <span class="input-icon-box"><i data-lucide="school"></i></span>
                    <input class="field-input" type="text" name="nama_sekolah" id="schoolInput" value="<?php echo e(old('nama_sekolah')); ?>" placeholder="Masukkan atau pilih nama sekolah asal" autocomplete="off" onfocus="showSchoolSuggestions()" oninput="filterSchoolSuggestions()">
                    <!-- Custom Suggestions Container -->
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="login-link">
            Sudah memiliki akun? <a href="<?php echo e(route('login')); ?>">Masuk di sini</a>
        </div>
    </form>
</div>
...
<script>
    ...
    let allSchools = <?php echo json_encode($schools, 15, 512) ?>;
...
</html><?php /**PATH D:\laragon\www\jeboll\resources\views/auth/register.blade.php ENDPATH**/ ?>