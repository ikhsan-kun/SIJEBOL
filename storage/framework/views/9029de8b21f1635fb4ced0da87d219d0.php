<?php $__env->startSection('title', 'Tambah Jadwal Baru - SI JEBOL'); ?>
...
<div class="form-header">
    ...
    <a href="<?php echo e(route('cabang.jadwal')); ?>" style="display: inline-flex; align-items: center; gap: 8px; background: rgba(255,255,255,0.2); color: white; padding: 10px 16px; border-radius: 8px; font-weight: 700; font-size: 0.85rem; text-decoration: none; backdrop-filter: blur(10px); border: 1px solid rgba(255,255,255,0.1);">
...
<form action="<?php echo e(request()->routeIs('cabang_dinas.*') ? route('cabang_dinas.jadwal.store') : route('cabang.jadwal.store')); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    ...
    <div class="card-panel">
        ...
        <div class="form-grid">
            <div class="field-group">
                ...
                <input type="text" name="nama_kegiatan" placeholder="Contoh: JEBOL KTP-el Kecamatan Tegal Barat" required class="field-input" value="<?php echo e(old('nama_kegiatan')); ?>">
            </div>

            <div class="field-group">
                <span class="field-label">Lokasi Pelayanan</span>
                <input type="text" name="lokasi" id="lokasi" required class="field-input" placeholder="Contoh: SMAN 1 Tegal atau Balai Desa" value="<?php echo e(old('lokasi')); ?>">
            </div>
        </div>
    ...
    <div class="card-panel">
        ...
        <div class="form-grid" style="grid-template-columns: repeat(auto-fit, minmax(200px, 1fr));">
            <div class="field-group">
                ...
                <input type="date" name="tanggal_pelayanan" required class="field-input" value="<?php echo e(old('tanggal_pelayanan')); ?>">
            </div>
            <div class="field-group">
                <span class="field-label">Jam Mulai</span>
                <input type="time" name="jam_mulai" required class="field-input" value="<?php echo e(old('jam_mulai')); ?>">
            </div>
            <div class="field-group">
                <span class="field-label">Jam Selesai</span>
                <input type="time" name="jam_selesai" required class="field-input" value="<?php echo e(old('jam_selesai')); ?>">
            </div>
        </div>
    </div>
    ...
    <div class="card-panel">
        ...
        <div class="field-group" style="margin-bottom: 0;">
            ...
            <textarea name="deskripsi" rows="4" placeholder="Contoh: Pelayanan JEBOL untuk pembuatan KTP-el, KIA, dan aktivasi IKD bagi masyarakat..." class="field-textarea"><?php echo e(old('deskripsi')); ?></textarea>
        </div>
    </div>
...
<?php echo $__env->make('layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\jeboll\resources\views/cabang/jadwal-baru.blade.php ENDPATH**/ ?>