<?php $__env->startSection('title', 'Verifikasi Pengajuan Layanan - SI JEBOL Admin'); ?>
...
<div class="dashboard-grid">
    <div class="stat-card">
        ...
        <div class="stat-info">
            ...
            <span class="stat-value"><?php echo e($totalPermohonan); ?></span>
    ...
    <div class="stat-card">
        ...
        <div class="stat-info">
            ...
            <span class="stat-value"><?php echo e($totalMenunggu); ?></span>
    ...
    <div class="stat-card">
        ...
        <div class="stat-info">
            ...
            <span class="stat-value"><?php echo e($totalTerverifikasi); ?></span>
    ...
    <div class="stat-card">
        ...
        <div class="stat-info">
            ...
            <span class="stat-value"><?php echo e($totalDitolak); ?></span>
...
<div class="panel-box">
    ...
    <div id="tab-individu">
        ...
        <div class="filter-panel">
            <form action="<?php echo e(route('admin.permohonan')); ?>" method="GET" class="filter-row">
                <div class="filter-group">
                    <label class="filter-label">Cari Pemohon</label>
                    <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Nama / NIK / No. HP..." class="filter-input">
                </div>
                ...
                <div class="filter-group">
                    ...
                    <select name="layanan" class="filter-input">
                        ...
                        <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $svc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($svc->nama_layanan); ?>" <?php echo e(request('layanan') == $svc->nama_layanan ? 'selected' : ''); ?>><?php echo e($svc->nama_layanan); ?></option>
                ...
                <div class="filter-group">
                    ...
                    <select name="status" class="filter-input">
                        ...
                        <option value="menunggu_verifikasi" <?php echo e(request('status') == 'menunggu_verifikasi' ? 'selected' : ''); ?>>Menunggu Verifikasi</option>
                ...
                <div class="filter-group" style="flex-grow: 2;">
                    ...
                    <div class="filter-date-group">
                        ...
                        <input type="date" name="tanggal_end" value="<?php echo e(request('tanggal_end')); ?>" disabled title="TBD" class="filter-input" style="background: #f1f5f9; cursor: not-allowed;">
                    </div>
                </div>
        ...
        <div style="overflow-x: auto;">
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?php echo e(($permohonan->currentPage() - 1) * $permohonan->perPage() + $loop->iteration); ?></td>
                        <td style="font-weight: 700; color: var(--primary);">
                            <a href="<?php echo e(route('admin.permohonan.detail', $p->id_pengajuan)); ?>" style="color: var(--primary); text-decoration: none;" onmouseover="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'">
                                <?php echo e($p->nomor_tiket); ?>

                            </a>
                        </td>
                        <td>
                            <div style="font-weight: 700; color: var(--text-main);"><?php echo e($p->masyarakat->nama ?? 'Anonim'); ?></div>
                            <div style="font-size: 0.8rem; color: var(--text-muted);">NIK. <?php echo e($p->nik); ?></div>
                        </td>
                        <td style="font-weight: 600; color: var(--text-main);"><?php echo e($p->lokasi_pelayanan ?? '-'); ?></td>
                        <td style="font-weight: 600; color: var(--text-muted);"><?php echo e($p->jenis_layanan); ?></td>
                        <td>
                            <div style="font-weight: 600; color: var(--text-main);"><?php echo e($p->tanggal_pengajuan ? $p->tanggal_pengajuan->format('d M Y') : '-'); ?></div>
                            <div style="font-size: 0.8rem; color: var(--text-muted);"><?php echo e($p->tanggal_pengajuan ? $p->tanggal_pengajuan->format('H:i') . ' WIB' : ''); ?></div>
                        </td>
                        <td>
                            <?php
                            ...
                            <span class="status-badge <?php echo e($badgeClass); ?>">
                                <i data-lucide="<?php echo e($icon); ?>" style="width: 14px; height: 14px;"></i>
                                <?php echo e(ucwords($statusText)); ?>

                            </span>
                        </td>
                        <td>
                            <div class="action-group">
                                <?php if($p->status == 'menunggu_verifikasi'): ?>
                                    <a href="<?php echo e(route('admin.permohonan.detail', $p->id_pengajuan)); ?>" class="btn btn-success">
                                        <i data-lucide="check-circle" style="width: 16px;"></i> Verifikasi
                                    </a>
                                <?php else: ?>
                                    <a href="<?php echo e(route('admin.permohonan.detail', $p->id_pengajuan)); ?>" class="btn btn-outline">
                                        <i data-lucide="eye" style="width: 16px;"></i> Detail
                                    </a>
                                <?php endif; ?>
                                <form action="<?php echo e(route('admin.permohonan.destroy', $p->id_pengajuan)); ?>" method="POST" onsubmit="return confirm('Yakin ingin menghapus pengajuan ini secara permanen?');" style="display:inline;">
    ...
    <div id="tab-rekap" style="display: none;">
        ...
        <div style="overflow-x: auto;">
            <table class="data-table">
                ...
                <tbody>
                    <?php if(isset($rekapLokasi) && count($rekapLokasi) > 0): ?>
                        <?php $__currentLoopData = $rekapLokasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rekap): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td style="font-weight: 700; color: var(--text-main); font-size: 1rem;">
                                <?php echo e($rekap->lokasi_pelayanan); ?>

                            </td>
                            <td>
                                <span style="font-size: 1.5rem; font-weight: 800; color: var(--primary);"><?php echo e($rekap->total); ?></span>
                                <span style="font-size: 0.85rem; color: var(--text-muted); font-weight: 600;">Orang</span>
                            </td>
                            <td>
                                <?php if(in_array($rekap->status, ['menunggu_verifikasi', 'menunggu_kuota', 'terverifikasi'])): ?>
                                    <span class="status-badge badge-menunggu"><i data-lucide="clock" style="width: 14px;"></i> Siap Dijadwalkan</span>
                                <?php elseif($rekap->status == 'terjadwal'): ?>
                                    <span class="status-badge badge-terjadwal"><i data-lucide="calendar" style="width: 14px;"></i> Terjadwal</span>
                                <?php elseif($rekap->status == 'diproses'): ?>
                                    <span class="status-badge badge-diproses"><i data-lucide="refresh-cw" style="width: 14px;"></i> Diproses</span>
                                <?php endif; ?>
                            </td>
                            <td>
                                <?php if(in_array($rekap->status, ['menunggu_verifikasi', 'menunggu_kuota', 'terverifikasi'])): ?>
                                    <button onclick="openBulkScheduleModal('<?php echo e($rekap->lokasi_pelayanan); ?>')" class="btn btn-primary">
                                        <i data-lucide="calendar-plus" style="width: 16px;"></i> Buat Jadwal
                                    </button>
                                <?php elseif(in_array($rekap->status, ['terjadwal', 'diproses'])): ?>
                                    <button onclick="openBulkCompleteModal('<?php echo e($rekap->lokasi_pelayanan); ?>', <?php echo e($rekap->total); ?>)" class="btn btn-success">
...
<div id="bulkScheduleModal" class="modal-backdrop">
    <div class="modal-content">
        ...
        <form action="<?php echo e(route('admin.permohonan.bulk-schedule')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
<div id="bulkCompleteModal" class="modal-backdrop">
    <div class="modal-content">
        ...
        <form action="<?php echo e(route('admin.permohonan.bulk-complete')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\jeboll\resources\views/admin/permohonan.blade.php ENDPATH**/ ?>