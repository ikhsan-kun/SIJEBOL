...
<div class="page-header">
            ...
            <div class="panel-box">
                ...
                <?php if($errors->any() && ($errors->has('current_password') || $errors->has('password'))): ?>
                ...
                <form action="<?php echo e(route('masyarakat.settings.password.update')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?><div class="form-hint" style="color: #ef4444;"><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-actions">
                        ...
                        <a href="<?php echo e(route('masyarakat.profile')); ?>" class="btn-outline">Batal</a>
                    </div>
                </form>
            </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.masyarakat', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\jeboll\resources\views/masyarakat/settings-password.blade.php ENDPATH**/ ?>