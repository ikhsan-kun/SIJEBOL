...
<div class="panel-box">
    ...
    <form action="<?php echo e(route('cabang.profil.update')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\jeboll\resources\views/cabang/profil-edit.blade.php ENDPATH**/ ?>