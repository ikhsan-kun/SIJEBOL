...
<div class="custom-hero">
    <div class="hero-content">
        ...
        <form method="GET" action="<?php echo e(route('admin.dashboard')); ?>" style="margin-top: 20px; display: flex; gap: 12px; align-items: center; background: rgba(255,255,255,0.1); padding: 12px 20px; border-radius: 12px; backdrop-filter: blur(5px); width: max-content; border: 1px solid rgba(255,255,255,0.2);">
