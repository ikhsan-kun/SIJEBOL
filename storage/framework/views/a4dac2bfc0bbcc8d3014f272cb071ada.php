...
<!-- Premium Header -->
            <div class="jbl-626 jbl-1004 jbl-454 jbl-496 jbl-1578 jbl-1298 jbl-287 jbl-1361 jbl-1109 jbl-35 responsive-header"
                 style="background-color: #003178; background-image: linear-gradient(rgba(0,49,120,0.9), rgba(0,49,120,0.9)), url('<?php echo e(asset('images/batik-tegal-premium.jpg')); ?>'); background-size: cover; border-bottom: 4px solid #f59e0b; box-shadow: 0 20px 40px rgba(0,49,120,0.15); border-radius: 0; margin: -24px -24px 32px -24px;">
                <div class="jbl-91 jbl-1062 jbl-907" style="background-image: url('<?php echo e(asset('images/batik-tegal-premium.jpg')); ?>'); background-size: 400px; opacity: 0.12; mix-blend-mode: luminosity;"></div>
            ...
            <div class="stats-grid">
                <div class="panel-card-modern" style="display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 12px; padding: 32px 24px;">
                    <div style="font-size: 2.5rem; font-weight: 800; color: #f59e0b; display: flex; align-items: center; gap: 4px; line-height: 1;">
                        <?php echo e($avgRating ? number_format($avgRating, 1) : '—'); ?> 
                ...
                <div class="panel-card-modern" style="display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 12px; padding: 32px 24px;">
                    <div style="font-size: 2.5rem; font-weight: 800; color: #003178; line-height: 1;"><?php echo e($tingkatKepuasan); ?>%</div>
                ...
                <div class="panel-card-modern" style="display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 12px; padding: 32px 24px;">
                    <div style="font-size: 2.5rem; font-weight: 800; color: #0f172a; line-height: 1;"><?php echo e($total); ?></div>
            ...
            <div class="main-grid">
                ...
                <div class="jbl-434 jbl-333 jbl-1319 jbl-1406 jbl-746 jbl-197 jbl-160 panel-card-modern">
                    ...
                    <form action="<?php echo e(route('masyarakat.kepuasan.store')); ?>" method="POST" enctype="multipart/form-data" class="jbl-66" style="display: flex; flex-direction: column; gap: 24px;">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="star-picker" x-data="{ rating: 0 }">
                                <?php for($s = 5; $s >= 1; $s--): ?>
                                    <input type="radio" id="star<?php echo e($s); ?>" name="nilai_kepuasan" value="<?php echo e($s); ?>" required @click="rating = <?php echo e($s); ?>">
                                    <label for="star<?php echo e($s); ?>" :style="rating >= <?php echo e($s); ?> ? 'color:#f59e0b' : ''">★</label>
                                <?php endfor; ?>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="status_layanan" required>
                                <option value="" disabled <?php echo e(!old('status_layanan') && !request('layanan') ? 'selected' : ''); ?>>Pilih layanan yang sudah selesai...</option>
                                <?php if($pengajuanSelesai->isEmpty()): ?>
                                    <option value="" disabled>— Belum ada layanan yang selesai —</option>
                                <?php else: ?>
                                    <?php $__currentLoopData = $pengajuanSelesai; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php $isSelected = old('status_layanan', request('layanan')) == $p->jenis_layanan; ?>
                                        <option value="<?php echo e($p->jenis_layanan); ?>" <?php echo e($isSelected ? 'selected' : ''); ?>>
                                            <?php echo e($p->jenis_layanan); ?>

                                            <?php if($p->nomor_tiket): ?> — Tiket: <?php echo e($p->nomor_tiket); ?> <?php endif; ?>
                                            <?php if($p->tanggal_selesai): ?> (<?php echo e($p->tanggal_selesai->format('d M Y')); ?>) <?php endif; ?>
                                        </option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" readonly
                                   value="<?php echo e(auth()->user()->name ?? auth()->user()->nama ?? '-'); ?>">
                            <input type="hidden" name="nik" value="<?php echo e(auth()->user()->nik); ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" rows="4"
                                      name="kritik_saran" placeholder="Tuliskan pengalaman atau saran Anda untuk perbaikan layanan..."><?php echo e(old('kritik_saran')); ?></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" readonly
                                   value="<?php echo e(now()->translatedFormat('d F Y, H:i')); ?> WIB">
                        </div>
                ...
                <div class="jbl-1293 jbl-1541 jbl-1485">
                    ...
                    <div class="jbl-434 jbl-333 jbl-1319 jbl-1406 jbl-746 jbl-160 panel-card-modern">
                        ...
                        <?php for($s = 5; $s >= 1; $s--): ?>
                            <?php $cnt = $riwayatAll->where('nilai_kepuasan', $s)->count(); $pct = $total > 0 ? ($cnt/$total*100) : 0; ?>
                            <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 12px;">
                                <span style="font-weight: 700; color: #f59e0b; width: 24px;"><?php echo e($s); ?>★</span>
                                <div style="flex-grow: 1; height: 8px; background: #f1f5f9; border-radius: 4px; overflow: hidden;">
                                    <div style="height: 100%; background: #f59e0b; width:<?php echo e($pct); ?>%; border-radius: 4px;"></div>
                                </div>
                                <span style="font-size: 0.85rem; font-weight: 600; color: #64748b; width: 24px; text-align: right;"><?php echo e($cnt); ?></span>
                            </div>
                        <?php endfor; ?>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="panel-card-modern" style="margin-top: 32px;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px; border-bottom: 1px solid #e2e8f0; padding-bottom: 16px;">
                            ...
                            <span style="background: #003178; color: white; font-size: 0.75rem; font-weight: 700; padding: 0 12px; height: 24px; display: inline-flex; align-items: center; justify-content: center; border-radius: 12px; letter-spacing: 0.5px;"><?php echo e($total); ?> data</span>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table-riwayat">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <?php echo e($item->tanggal_input ? $item->tanggal_input->format('d M Y, H:i') : '-'); ?> WIB
                                        </td>
                                        <td style="font-weight: 600;">
                                            <?php echo e($item->masyarakat->name ?? $item->masyarakat->nama ?? 'Anonim'); ?>

                                        </td>
                                        <td style="font-weight: 600;">
                                            <?php echo e($item->status_layanan ?? '-'); ?>

                                        </td>
                                        <td style="text-align: center;">
                                            <div style="display: flex; align-items: center; justify-content: center; gap: 4px;">
                                                <span style="font-weight: 700; color: #f59e0b;"><?php echo e(number_format($item->nilai_kepuasan, 1)); ?></span>
                                                <span style="color: #f59e0b; font-size: 1.1rem;">★</span>
                                            </div>
                                        </td>
                                        <td>
                                            <?php if($item->kritik_saran): ?>
                                                <p style="font-style: italic; color: #64748b; margin: 0 0 8px 0;">"<?php echo e(Str::limit($item->kritik_saran, 80)); ?>"</p>
                                            <?php else: ?>
                                            ...
                                            <?php if($item->foto_path): ?>
                                                <div class="jbl-1305">
                                                    <button type="button" @click="imgModalSrc = '<?php echo e(Storage::url($item->foto_path)); ?>'; imgModalOpen = true" class="jbl-823 jbl-843 jbl-959 jbl-1066 jbl-1023 jbl-602 jbl-1426 jbl-995 jbl-212 jbl-262 jbl-145 jbl-1300 jbl-632">
...
<?php echo $__env->make('layouts.masyarakat', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\jeboll\resources\views/masyarakat/kepuasan.blade.php ENDPATH**/ ?>