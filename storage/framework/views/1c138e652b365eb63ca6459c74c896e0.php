...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> - SI JEBOL</title>
    ...
    <div class="sidebar">
        <div class="sidebar-brand">
            <div class="sidebar-logo-box">
                <img src="<?php echo e(asset('images/logo-tegal.png')); ?>" alt="Logo" style="width: 100%; height: 100%; object-fit: contain; filter: drop-shadow(0 0 12px rgba(255, 255, 255, 0.6));">
            </div>
            <div>
                <h2>SI JEBOL</h2>
        ...
        <?php if($authUser && in_array(trim(strtolower($authUser->role ?? '')), ['admin', 'admin pusat'])): ?>
            <!-- Admin Menu -->
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>">
                <i data-lucide="layout-dashboard"></i> DASHBOARD
            </a>
            <a href="<?php echo e(route('admin.permohonan') ?? '#'); ?>" class="nav-link <?php echo e(request()->routeIs('admin.permohonan', 'admin.permohonan.*') ? 'active' : ''); ?>">
                <i data-lucide="file-text"></i> PERMOHONAN
            </a>
            <a href="<?php echo e(route('admin.jadwal') ?? '#'); ?>" class="nav-link <?php echo e(request()->routeIs('admin.jadwal', 'admin.jadwal.*') ? 'active' : ''); ?>">
                <i data-lucide="calendar"></i> JADWAL JEBOL
            </a>
            <a href="<?php echo e(route('admin.laporan') ?? '#'); ?>" class="nav-link <?php echo e(request()->routeIs('admin.laporan', 'admin.laporan.*') ? 'active' : ''); ?>">
                <i data-lucide="bar-chart"></i> LAPORAN
            </a>
            <a href="<?php echo e(route('admin.kepuasan.index') ?? '#'); ?>" class="nav-link <?php echo e(request()->routeIs('admin.kepuasan', 'admin.kepuasan.*') ? 'active' : ''); ?>">
                <i data-lucide="star"></i> PENILAIAN LAYANAN
            </a>
        <?php elseif($authUser && in_array(trim(strtolower($authUser->role ?? '')), ['cabang', 'cabang_dinas', 'petugas', 'petugas cabang', 'petugas kecamatan'])): ?>
            <!-- Cabang Dinas Menu -->
            <a href="<?php echo e(route('cabang.dashboard')); ?>" class="nav-link <?php echo e(request()->routeIs('cabang.dashboard') ? 'active' : ''); ?>">
                <i data-lucide="layout-dashboard"></i> DASHBOARD
            </a>
            <a href="<?php echo e(route('cabang.sekolah') ?? '#'); ?>" class="nav-link <?php echo e(request()->routeIs('cabang.sekolah', 'cabang.sekolah.*') ? 'active' : ''); ?>">
                <i data-lucide="school"></i> KELOLA DATA SEKOLAH
            </a>
            <a href="<?php echo e(route('cabang.monitoring') ?? '#'); ?>" class="nav-link <?php echo e(request()->routeIs('cabang.monitoring', 'cabang.monitoring.*') ? 'active' : ''); ?>">
                <i data-lucide="clipboard-list"></i> MONITORING PENGAJUAN SEKOLAH
            </a>
            <a href="<?php echo e(route('cabang.jadwal') ?? '#'); ?>" class="nav-link <?php echo e(request()->routeIs('cabang.jadwal', 'cabang.jadwal.*') ? 'active' : ''); ?>">
                <i data-lucide="calendar"></i> JADWAL PELAYANAN
            </a>
            <a href="<?php echo e(route('cabang.laporan') ?? '#'); ?>" class="nav-link <?php echo e(request()->routeIs('cabang.laporan', 'cabang.laporan.*') ? 'active' : ''); ?>">
        ...
        <?php if($authUser && in_array(trim(strtolower($authUser->role ?? '')), ['admin', 'admin pusat'])): ?>
            ...
            <a href="<?php echo e(route('admin.settings.users') ?? '#'); ?>" class="nav-link <?php echo e(request()->routeIs('admin.settings', 'admin.settings.*') ? 'active' : ''); ?>">
        ...
        <div class="sidebar-bottom">
            <?php if($authUser && in_array(trim(strtolower($authUser->role ?? '')), ['admin', 'admin pusat'])): ?>
                <a href="<?php echo e(route('admin.jadwal.create') ?? '#'); ?>" class="sidebar-btn primary">
    ...
    <div class="main-content">
        ...
        <header class="top-header">
            <div style="display: flex; align-items: center; gap: 12px; flex: 1;">
                ...
                ?>
                <form action="<?php echo e($searchAction); ?>" method="GET" class="header-search">
                    <i data-lucide="search"></i>
                    <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="<?php echo e($searchPlaceholder); ?>">
                </form>
            </div>
            ...
            <div class="user-profile">
                ...
                <div x-data="{ open: false }" style="position: relative;">
                    ...
                    <div x-show="open" 
                        ...
                        <?php if($pendingCount > 0): ?>
                            <a href="<?php echo e(route('admin.permohonan')); ?>" class="notif-item">
                                <div class="notif-icon" style="background: #fef3c7; color: #d97706;">
                                    <i data-lucide="file-warning" style="width: 16px; height: 16px;"></i>
                                </div>
                                <div class="notif-content">
                                    <p class="notif-title"><?php echo e($pendingCount); ?> Permohonan Menunggu</p>
                            ...
                            <?php $__currentLoopData = $recentPending; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(route('admin.permohonan', ['search' => $p->nomor_tiket])); ?>" class="notif-item">
                                    <div class="notif-icon">
                                        <i data-lucide="file-text" style="width: 16px; height: 16px;"></i>
                                    </div>
                                    <div class="notif-content">
                                        <p class="notif-title">Layanan <?php echo e($p->jenis_layanan); ?></p>
                                        <p class="notif-desc"><?php echo e($p->nomor_tiket); ?> - <?php echo e($p->tanggal_pengajuan ? \Carbon\Carbon::parse($p->tanggal_pengajuan)->diffForHumans() : ''); ?></p>
                                    </div>
                                </a>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('admin.permohonan')); ?>" style="display: block; text-align: center; padding: 12px; font-size: 0.8rem; font-weight: 700; color: var(--primary); text-decoration: none; border-top: 1px solid #f1f5f9; background: #f8fafc; border-bottom-left-radius: 16px; border-bottom-right-radius: 16px;">Lihat Semua Notifikasi</a>
                        <?php else: ?>
                ...
                <div x-data="{ open: false }" style="position: relative;">
                    <button @click="open = !open" @click.away="open = false" class="user-profile-btn">
                        <div class="avatar">
                            <?php if($authUser && isset($authUser->foto_profil) && $authUser->foto_profil): ?>
                                <img src="<?php echo e(asset('storage/' . $authUser->foto_profil)); ?>" alt="Avatar" style="width: 100%; height: 100%; object-fit: cover;">
                            <?php else: ?>
                                <?php echo e(strtoupper(substr($authUser->name ?? 'K', 0, 2))); ?>

                            <?php endif; ?>
                        </div>
                        <div class="user-info">
                            <span class="user-name"><?php echo e($authUser->name ?? 'Kecamatan'); ?></span>
                            <span class="user-role"><?php echo e(str_replace('_', ' ', $authUser->role ?? 'Role')); ?></span>
                        </div>
                    ...
                    <div x-show="open" 
                        ...
                        <div style="padding: 16px 20px; border-bottom: 1px solid #f1f5f9;">
                            <p style="margin: 0; font-weight: 800; font-size: 0.95rem; color: var(--text-main);"><?php echo e($authUser->name ?? 'User'); ?></p>
                            <p style="margin: 4px 0 0; font-size: 0.8rem; color: var(--text-muted);"><?php echo e($authUser->email ?? ''); ?></p>
                        </div>
                        
                        <div style="padding: 8px 0;">
                            <?php if(in_array(trim(strtolower($authUser->role ?? '')), ['admin', 'admin pusat'])): ?>
                                <a href="<?php echo e(route('admin.profil')); ?>" class="dropdown-item">
                                    <i data-lucide="user"></i> Profil Saya
                                </a>
                                <a href="<?php echo e(route('admin.settings.about')); ?>" class="dropdown-item">
                                    <i data-lucide="settings"></i> Pengaturan
                                </a>
                            <?php else: ?>
                                <a href="<?php echo e(route('cabang.profil')); ?>" class="dropdown-item">
                                    <i data-lucide="user"></i> Profil Saya
                                </a>
                            <?php endif; ?>
                        </div>
                        ...
                        <form method="POST" action="<?php echo e(route('logout')); ?>" style="margin: 0; padding: 8px 0;">
                            <?php echo csrf_field(); ?>
...
<?php /**PATH D:\laragon\www\jeboll\resources\views/layouts/panel.blade.php ENDPATH**/ ?>