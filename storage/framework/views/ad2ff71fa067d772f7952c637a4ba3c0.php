...
<!-- Hero Banner -->
        ...
        <div class="content-container">
            <!-- Filter Bar -->
            <form method="GET" action="<?php echo e(route('masyarakat.jadwal')); ?>" class="filter-bar">
        ...
        <div class="bottom-grid">
            ...
            <div class="panel-card" id="calendar-panel">
                <div class="panel-header">
                    <h3 class="panel-title">Kalender <?php echo e($monthName); ?></h3>
                </div>
                <div class="cal-grid">
                ...
                <div class="schedule-list">
                    <?php $__empty_1 = true; $__currentLoopData = $upcoming; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $act): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <div class="schedule-item" onclick="showCalDetail('<?php echo e($act->tanggal_pelayanan->format('Y-m-d')); ?>')">
                            <div class="sch-icon" style="background: <?php echo e($iconBg); ?>; color: <?php echo e($iconColor); ?>;"><i data-lucide="calendar-days" style="width: 20px; height: 20px;"></i></div>
...
<?php echo $__env->make('layouts.masyarakat', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\jeboll\resources\views/masyarakat/jadwal.blade.php ENDPATH**/ ?>