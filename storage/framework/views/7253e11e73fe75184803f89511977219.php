...
<body class="no-batik">
    ...
    <main class="main-content">
        ...
        <div class="content-container">
            <!-- Filter Bar -->
            <form method="GET" action="<?php echo e(route('jadwal')); ?>" class="filter-bar">
            ...
            <div class="filter-group">
                ...
                <select name="wilayah">
                    ...
                    <option value="Tegal Barat" <?php echo e(request('wilayah') == 'Tegal Barat' ? 'selected' : ''); ?>>Tegal Barat</option>
                    <option value="Tegal Timur" <?php echo e(request('wilayah') == 'Tegal Timur' ? 'selected' : ''); ?>>Tegal Timur</option>
                    <option value="Tegal Selatan" <?php echo e(request('wilayah') == 'Tegal Selatan' ? 'selected' : ''); ?>>Tegal Selatan</option>
                    <option value="Margadana" <?php echo e(request('wilayah') == 'Margadana' ? 'selected' : ''); ?>>Margadana</option>
                </select>
            </div>
            ...
            <div class="panel-card" id="calendar-panel">
                ...
                <div class="cal-grid">
                    ...
                    <?php $__currentLoopData = $calendar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <button class="cal-cell <?php echo e(!$item['isCurrentMonth'] ? 'muted' : ''); ?> <?php echo e($hasEvent ? $indicatorClass : ''); ?>" 
                            <?php if($hasEvent): ?> 
                                onclick="showCalDetail('<?php echo e($dateString); ?>', this)" 
                                data-date="<?php echo e($dateString); ?>"
                            <?php endif; ?>
                        >
                            <?php echo e($item['date']->day); ?>
...
<?php /**PATH D:\laragon\www\jeboll\resources\views/pengunjung/jadwal.blade.php ENDPATH**/ ?>