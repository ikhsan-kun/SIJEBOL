...
<div class="top-grid">
                ...
                <div class="profile-card">
                    <div class="profile-avatar" style="overflow: hidden; padding: 0;">
                        <?php if(auth()->user()->foto_profil ?? auth()->user()->profile_photo_path): ?>
                            <img src="<?php echo e(asset('storage/' . (auth()->user()->foto_profil ?? auth()->user()->profile_photo_path))); ?>" alt="Profile Avatar" style="width: 100%; height: 100%; object-fit: cover;">
                        <?php else: ?>
                            <i data-lucide="user" style="width:32px; height:32px;"></i>
                        <?php endif; ?>
                    </div>
                    <h3 class="profile-name"><?php echo e(auth()->user()->nama ?? auth()->user()->name ?? '-'); ?></h3>
                    <p class="profile-nik"><?php echo e(auth()->user()->email ?? '-'); ?></p>
                    <span class="profile-badge">TERVERIFIKASI <i data-lucide="check-circle-2" style="width:12px; height:12px;"></i></span>
                    <a href="<?php echo e(route('masyarakat.settings')); ?>" class="btn-profile"><i data-lucide="user" style="width:16px;"></i> Lihat Profil</a>
                </div>
            </div>
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        ...
                        <p class="stat-value"><?php echo e($totalPengajuan); ?></p>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        ...
                        <p class="stat-value"><?php echo e($statusMenunggu); ?></p>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        ...
                        <p class="stat-value"><?php echo e($statusProses); ?></p>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        ...
                        <p class="stat-value"><?php echo e($statusSelesai); ?></p>
                    ...
                    <div style="display: flex; align-items: center; justify-content: center; gap: 12px; width: 100%;">
                        <div style="position: relative; width: 56px; height: 56px; flex-shrink: 0;">
                            ...
                            <div style="position: absolute; inset: 0; display: flex; flex-direction: column; align-items: center; justify-content: center; pointer-events: none;">
                                <span style="font-size: 0.7rem; font-weight: 800; color: #1e293b; text-align: center;"><?php echo e($statusSelesai); ?></span>
                            </div>
                        </div>
                        <div style="display: flex; flex-direction: column; gap: 4px; font-size: 0.6rem;">
                            <div style="display: flex; justify-content: space-between; gap: 6px;">
                                ...
                                <span style="color: #64748b; font-weight: 600;">(<?php echo e($statusSelesai > 0 ? round(($rekapSelesaiData[0] / $statusSelesai) * 100) : 0); ?>%)</span>
                            </div>
                            <div style="display: flex; justify-content: space-between; gap: 6px;">
                                <div style="display: flex; align-items: center; gap: 4px;">
                                ...
                                <span style="color: #64748b; font-weight: 600;">(<?php echo e($statusSelesai > 0 ? round(($rekapSelesaiData[1] / $statusSelesai) * 100) : 0); ?>%)</span>
                            </div>
                            <div style="display: flex; justify-content: space-between; gap: 6px;">
                                <div style="display: flex; align-items: center; gap: 4px;">
                                ...
                                <span style="color: #64748b; font-weight: 600;">(<?php echo e($statusSelesai > 0 ? round(($rekapSelesaiData[2] / $statusSelesai) * 100) : 0); ?>%)</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="action-grid">
                <a href="<?php echo e(route('pengajuan')); ?>?layanan=KTP-el" class="action-card">
                ...
                <a href="<?php echo e(route('pengajuan')); ?>?layanan=KIA" class="action-card">
                ...
                <a href="<?php echo e(route('pengajuan')); ?>?layanan=IKD" class="action-card">
                ...
                <a href="<?php echo e(route('masyarakat.cek-status')); ?>" class="action-card">
                ...
                <div class="panel-card">
                    ...
                    <div class="table-responsive">
                        <table class="table-riwayat">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $lastPermohonan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td style="font-weight: 600;">
                                        <a href="<?php echo e(route('masyarakat.cek-status')); ?>?search=<?php echo e($lp->nomor_tiket); ?>" style="color: inherit; text-decoration: none;" onmouseover="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'">
                                            #<?php echo e($lp->nomor_tiket); ?>

                                        </a>
                                    </td>
                                    <td style="font-weight: 600;"><?php echo e($lp->jenis_layanan); ?></td>
                                    <td><?php echo e($lp->tanggal_pengajuan ? $lp->tanggal_pengajuan->format('d M Y') : '--'); ?></td>
                                    <td>
                                        <?php
                                        ...
                                        ?>
                                        <span class="status-badge <?php echo e($badgeClass); ?>"><?php echo e(strtoupper($text)); ?></span>
                                    </td>
                                    <td><a href="<?php echo e(route('masyarakat.cek-status')); ?>?search=<?php echo e($lp->nomor_tiket); ?>" class="btn-lihat">Lihat</a></td>
                                </tr>
                    ...
                    <div style="margin-top: 16px;">
                        <a href="<?php echo e(route('masyarakat.cek-status')); ?>" style="font-size: 0.8rem; font-weight: 700; color: #3b82f6; text-decoration: none; display: flex; align-items: center; gap: 4px;">
...
<?php echo $__env->make('layouts.masyarakat', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\jeboll\resources\views/masyarakat/dashboard.blade.php ENDPATH**/ ?>