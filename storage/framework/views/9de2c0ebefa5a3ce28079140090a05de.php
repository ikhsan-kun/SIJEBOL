...
<head>
    ...
    <style>
        ...
        .hero-section {
            ...
            background-image: linear-gradient(rgba(0, 49, 120, 0.9), rgba(0, 49, 120, 0.9)), url('<?php echo e(asset('images/batik-tegal-premium.jpg')); ?>');
...
<body x-data="{ sidebarOpen: false }">
    ...
    <div class="dashboard-layout">
        ...
        <div class="tracking-container">
            <?php if($search): ?>
                <a href="<?php echo e(route('masyarakat.cek-status')); ?>" style="display: inline-flex; align-items: center; gap: 8px; color: #64748b; font-weight: 700; font-size: 0.85rem; margin-bottom: 24px; text-decoration: none;">
            ...
            <section class="hero-section">
                ...
                <div class="search-wrapper">
                    <form action="<?php echo e(route('masyarakat.cek-status')); ?>" method="GET" class="search-capsule">
                        <div class="search-input-group">
                            <i data-lucide="search" width="20" height="20"></i>
                            <input type="text" name="search" placeholder="Masukkan Nomor Tiket..." value="<?php echo e($search); ?>" autocomplete="off">
                        </div>
                ...
                <div class="result-card" id="detail-pengajuan">
                    <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 40px; flex-wrap: wrap; gap: 20px;">
                        <div>
                            ...
                            <h2 style="font-size: 2rem; font-weight: 800; color: var(--primary); margin: 0;"><?php echo e($permohonan->jenis_layanan); ?></h2>
                            <p style="font-size: 0.9rem; font-weight: 700; color: #64748b; margin-top: 8px;">TIKET: <span style="color: var(--primary);">#<?php echo e($permohonan->nomor_tiket); ?></span></p>
                        </div>
                        <?php
                        ...
                        ?>
                        <span style="padding: 10px 20px; border-radius: 50px; font-weight: 800; font-size: 0.8rem; letter-spacing: 0.5px; <?php echo e($sClass); ?>">
                            <?php echo e($sLabel); ?>
                    ...
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: 16px; margin-bottom: 48px;">
                        <div style="background: #f8fafc; padding: 24px; border-radius: 24px; border: 1px solid #f1f5f9;">
                            ...
                            <p style="font-weight: 800; color: #1e293b; font-size: 0.95rem;"><?php echo e(strtoupper($permohonan->masyarakat->nama ?? '--')); ?></p>
                        </div>
                        <div style="background: #f8fafc; padding: 24px; border-radius: 24px; border: 1px solid #f1f5f9;">
                            <p style="font-size: 0.65rem; font-weight: 800; color: #94a3b8; text-transform: uppercase; margin-bottom: 8px;">NIK</p>
                            <p style="font-weight: 800; color: #1e293b; font-size: 0.95rem;"><?php echo e($permohonan->masyarakat->nik ?? '--'); ?></p>
                        </div>
                        <div style="background: #f8fafc; padding: 24px; border-radius: 24px; border: 1px solid #f1f5f9;">
                            <p style="font-size: 0.65rem; font-weight: 800; color: #94a3b8; text-transform: uppercase; margin-bottom: 8px;">Tanggal</p>
                            <p style="font-weight: 800; color: #1e293b; font-size: 0.95rem;"><?php echo e($permohonan->tanggal_pengajuan ? $permohonan->tanggal_pengajuan->format('d M Y') : '--'); ?></p>
                        </div>
                        <div style="background: #f8fafc; padding: 24px; border-radius: 24px; border: 1px solid #f1f5f9;">
                            <p style="font-size: 0.65rem; font-weight: 800; color: #94a3b8; text-transform: uppercase; margin-bottom: 8px;">Lokasi</p>
                            <p style="font-weight: 800; color: #1e293b; font-size: 0.95rem;"><?php echo e($permohonan->lokasi_pelayanan ?? '--'); ?></p>
                        </div>
                    </div>
                    ...
                    <?php if(in_array($st, ['terjadwal', 'diproses', 'selesai']) && ($permohonan->tanggal_kedatangan || $permohonan->jumlah_petugas)): ?>
                        ...
                        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(140px, 1fr)); gap: 12px; position: relative;">
                            <div style="background: white; padding: 16px; border-radius: 16px; text-align: center; border: 1px solid #e2e8f0; box-shadow: 0 2px 8px rgba(0,0,0,0.02);">
                                ...
                                <div style="font-size: 1rem; font-weight: 800; color: var(--primary);">
                                    <?php echo e($permohonan->tanggal_kedatangan ? \Carbon\Carbon::parse($permohonan->tanggal_kedatangan)->translatedFormat('d F Y') : '--'); ?>
                            ...
                            <div style="background: white; padding: 16px; border-radius: 16px; text-align: center; border: 1px solid #e2e8f0; box-shadow: 0 2px 8px rgba(0,0,0,0.02);">
                                ...
                                <div style="font-size: 1rem; font-weight: 800; color: #1e293b;">
                                    <?php if($jadwalWaktuMulai && $jadwalWaktuSelesai): ?>
                                        <?php echo e($jadwalWaktuMulai); ?> - <?php echo e($jadwalWaktuSelesai); ?> WIB
                                    <?php else: ?>
                                        --
                                    <?php endif; ?>
                                </div>
                            ...
                            <div style="background: white; padding: 16px; border-radius: 16px; text-align: center; border: 1px solid #e2e8f0; box-shadow: 0 2px 8px rgba(0,0,0,0.02);">
                                ...
                                <div style="font-size: 1rem; font-weight: 800; color: #16a34a;">
                                    <?php echo e($permohonan->jumlah_petugas ? $permohonan->jumlah_petugas . ' Orang' : '--'); ?>
                    ...
                    <div class="timeline-box">
                        ...
                        <div class="t-step <?php echo e($isDitolak ? '' : ($currentIdx > $s['idx'] ? 'done' : ($currentIdx === $s['idx'] ? 'active' : ''))); ?>">
                            <div class="t-icon">
                                <?php if(!$isDitolak && $currentIdx > $s['idx']): ?>
                                    <i data-lucide="check" width="24" height="24"></i>
                                <?php else: ?>
                                    <i data-lucide="<?php echo e($s['icon']); ?>" width="24" height="24"></i>
                                <?php endif; ?>
                            </div>
                            <div class="t-label"><?php echo e($s['label']); ?></div>
                            <div class="t-time">
                                <?php if($isDitolak): ?> Ditolak
                                <?php elseif($currentIdx > $s['idx']): ?> Selesai
                                <?php elseif($currentIdx === $s['idx']): ?> Saat ini
                                <?php else: ?> Menunggu <?php endif; ?>
                            </div>
                        </div>
                    ...
                    <?php if($permohonan->keterangan): ?>
                        <div style="background: #fef2f2; border: 1px solid #fee2e2; border-radius: 20px; padding: 20px; margin-top: 32px;">
                            ...
                            <p style="color: #991b1b; font-size: 0.9rem; font-weight: 500;"><?php echo e($permohonan->keterangan); ?></p>
                        </div>
                    <?php endif; ?>
                    ...
                    <div style="margin-top: 48px; padding-top: 32px; border-top: 1px solid #f1f5f9; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 20px;">
                        ...
                        <div style="display: flex; gap: 12px;">
                            ...
                            <a href="<?php echo e(route('masyarakat.kepuasan')); ?>?layanan=<?php echo e(urlencode($permohonan->jenis_layanan)); ?>" style="padding: 12px 24px; border-radius: 12px; background: #FFC107; color: #003178; border: none; font-weight: 900; text-decoration: none; display: inline-flex; align-items: center; gap: 8px; box-shadow: 0 10px 20px rgba(255, 193, 7, 0.3);">
                    ...
                    <div class="stats-grid-container">
                        <div class="stat-card">
                            ...
                            <div class="stat-content">
                                <p>Total Pengajuan</p>
                                <h3><?php echo e($totalPengajuan ?? 0); ?> <span>Dokumen</span></h3>
                            </div>
                        </div>
                        <div class="stat-card">
                            ...
                            <div class="stat-content">
                                <p>Sudah Selesai</p>
                                <h3><?php echo e($totalSelesai ?? 0); ?> <span>Dokumen</span></h3>
                            </div>
                        </div>
                        ...
                        <div class="stat-card">
                            ...
                            <div class="stat-content">
                                <p>Sedang Diproses</p>
                                <h3><?php echo e($totalBelum ?? 0); ?> <span>Dokumen</span></h3>
                            </div>
                        </div>
                        ...
                        <div class="stat-card">
                            ...
                            <div class="stat-content">
                                <p>Ditolak / Dihapus</p>
                                <h3><?php echo e($totalDitolak ?? 0); ?> <span>Dokumen</span></h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style="background: white; border-radius: 24px; box-shadow: 0 10px 30px rgba(0,49,120,0.03); border: 1px solid rgba(0,49,120,0.05); overflow: hidden;">
                                ...
                                <tbody>
                                    ...
                                    <tr style="border-bottom: 1px solid #f1f5f9; transition: background 0.2s;" onmouseover="this.style.background='#f8fafc'" onmouseout="this.style.background='white'">
                                        <td style="padding: 20px 24px; font-family: monospace; font-weight: 700; color: var(--primary); font-size: 0.95rem;">
                                            <a href="<?php echo e(route('masyarakat.cek-status', ['search' => $r->nomor_tiket])); ?>#detail-pengajuan" style="color: var(--primary); text-decoration: none;" onmouseover="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'">
                                                #<?php echo e($r->nomor_tiket); ?>
                                        ...
                                        <td style="padding: 20px 24px; font-weight: 800; color: #1e293b;">
                                            <div style="display: flex; align-items: center; gap: 10px;">
                                                ...
                                                <?php echo e($r->jenis_layanan); ?>

                                            </div>
                                        </td>
                                        <td style="padding: 20px 24px;">
                                            <div style="display: flex; flex-direction: column; gap: 6px;">
                                                <span style="font-size: 0.8rem; color: #64748b; font-weight: 600; display: flex; justify-content: space-between; width: 170px;">Dibuat: <strong style="color: #0f172a;"><?php echo e($r->tanggal_pengajuan ? $r->tanggal_pengajuan->format('d M Y') : '--'); ?></strong></span>
                                                <span style="font-size: 0.8rem; color: #64748b; font-weight: 600; display: flex; justify-content: space-between; width: 170px;">Jemput Bola: <strong style="color: #3b82f6;"><?php echo e($r->tanggal_kedatangan ? \Carbon\Carbon::parse($r->tanggal_kedatangan)->format('d M Y') : 'Menunggu'); ?></strong></span>
                                            </div>
                                        </td>
                                        <td style="padding: 20px 24px;">
                                            <div style="display: flex; flex-direction: column; gap: 6px;">
                                                <span style="font-size: 0.8rem; color: #64748b; font-weight: 600; display: flex; justify-content: space-between; max-width: 120px;">Target: <strong style="color: #0f172a;"><?php echo e($r->jumlah_orang ?? 0); ?></strong></span>
                                                <span style="font-size: 0.8rem; color: #64748b; font-weight: 600; display: flex; justify-content: space-between; max-width: 120px;">Selesai: <strong style="color: #16a34a;"><?php echo e(max($r->jumlah_realisasi ?? 0, max($r->jumlah_ikd ?? 0, $r->jumlah_kia ?? 0))); ?></strong></span>
                                            </div>
                                        </td>
                                        <td style="padding: 20px 24px; text-align: center;">
                                            <a href="<?php echo e(route('masyarakat.cek-status', ['search' => $r->nomor_tiket])); ?>#detail-pengajuan" style="background: #eff6ff; color: #3b82f6; padding: 8px 16px; border-radius: 8px; display: inline-flex; align-items: center; justify-content: center; gap: 8px; font-weight: 800; text-decoration: none; font-size: 0.8rem; transition: all 0.2s;" onmouseover="this.style.background='#3b82f6'; this.style.color='white'" onmouseout="this.style.background='#eff6ff'; this.style.color='#3b82f6'">
                        ...
                        <div class="pagination-premium-v2" style="padding: 16px 24px; background: #f8fafc; margin-top: 0; border-top: 1px solid #f1f5f9; border-bottom-left-radius: 24px; border-bottom-right-radius: 24px;">
                            <div class="pagination-info">
                                Menampilkan <?php echo e($riwayat->firstItem() ?? 0); ?>-<?php echo e($riwayat->lastItem() ?? 0); ?> dari <?php echo e($riwayat->total()); ?> dokumen
                            </div>
                            <div class="pagination-controls-v2">
                                ...
                                <?php else: ?>
                                    <a href="<?php echo e($riwayat->previousPageUrl()); ?>" class="page-nav-btn"><i data-lucide="chevron-left" width="18" height="18"></i></a>
                                <?php endif; ?>
                                ...
                                <?php if($start > 1): ?>
                                    <a href="<?php echo e($riwayat->url(1)); ?>" class="page-nav-btn">1</a>
                                    <?php if($start > 2): ?>
                                ...
                                <?php for($i = $start; $i <= $end; $i++): ?>
                                    <?php if($i == $riwayat->currentPage()): ?>
                                        <span class="page-nav-btn active"><?php echo e($i); ?></span>
                                    <?php else: ?>
                                        <a href="<?php echo e($riwayat->url($i)); ?>" class="page-nav-btn"><?php echo e($i); ?></a>
                                    <?php endif; ?>
                                <?php endfor; ?>

                                <?php if($end < $riwayat->lastPage()): ?>
                                    <?php if($end < $riwayat->lastPage() - 1): ?>
                                        <span class="page-nav-btn disabled" style="border:none; background:transparent;">...</span>
                                    <?php endif; ?>
                                    <a href="<?php echo e($riwayat->url($riwayat->lastPage())); ?>" class="page-nav-btn"><?php echo e($riwayat->lastPage()); ?></a>
                                <?php endif; ?>

                                <?php if($riwayat->hasMorePages()): ?>
                                    <a href="<?php echo e($riwayat->nextPageUrl()); ?>" class="page-nav-btn"><i data-lucide="chevron-right" width="18" height="18"></i></a>
                                <?php else: ?>
    ...
    <script>
        ...
        function unduhBuktiPDF() {
            ...
            setTimeout(() => {
                ...
                const opt = {
                    margin: 0,
                    filename: 'Bukti_Jebol_<?php echo e($permohonan->nomor_tiket ?? "000"); ?>.pdf',
    ...
    <?php if($permohonan && $permohonan->status == 'selesai'): ?>
    ...
    <div id="kepuasanModal" class="modal-overlay" style="z-index: 2100;" onclick="if(event.target === this) document.getElementById('kepuasanModal').classList.remove('active')">
        <div class="modal-content" style="text-align: center; padding: 48px;">
            ...
            <div style="display: flex; gap: 16px; justify-content: center;">
                ...
                <a href="<?php echo e(route('masyarakat.kepuasan')); ?>?layanan=<?php echo e(urlencode($permohonan->jenis_layanan)); ?>" style="padding: 14px 28px; border-radius: 16px; background: #f59e0b; color: white; border: none; font-weight: 800; text-decoration: none; cursor: pointer; box-shadow: 0 10px 20px rgba(245, 158, 11, 0.3); transition: all 0.3s;">Isi Penilaian Sekarang</a>
            </div>
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (!sessionStorage.getItem('kepuasan_prompted_<?php echo e($permohonan->nomor_tiket); ?>')) {
                setTimeout(() => {
                    document.getElementById('kepuasanModal').classList.add('active');
                    sessionStorage.setItem('kepuasan_prompted_<?php echo e($permohonan->nomor_tiket); ?>', 'true');
                }, 1000);
            }
        });
    </script>
...
<?php /**PATH D:\laragon\www\jeboll\resources\views/masyarakat/cek-status.blade.php ENDPATH**/ ?>