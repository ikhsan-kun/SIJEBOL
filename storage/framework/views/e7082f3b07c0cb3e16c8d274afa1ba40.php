<?php $__env->startSection('title', 'Laporan Strategis - SI JEBOL'); ?>
...
<div class="custom-hero">
    <div class="hero-content">
        ...
        <p class="hero-subtitle">Monitoring capaian layanan kependudukan Kota Tegal. Data terakhir diperbarui pada <?php echo e(now()->translatedFormat('d M Y, H:i')); ?> WIB.</p>
    </div>
...
<div class="filter-panel">
    <form action="<?php echo e(route('admin.laporan')); ?>" method="GET" class="filter-row">
        ...
        <div class="filter-group">
            ...
            <select name="tahun" class="filter-select" onchange="this.form.submit()">
                ...
                <?php for($i = $currentYear; $i >= $currentYear - 3; $i--): ?>
        ...
        <div class="filter-group">
            ...
            <select name="kecamatan" class="filter-select" onchange="this.form.submit()">
                <option value="" <?php echo e(empty($kecamatan) ? 'selected' : ''); ?>>-- Semua Wilayah --</option>
                <?php $__currentLoopData = $masterKecamatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($kec->nama); ?>" <?php echo e((strtoupper(str_ireplace(['Kecamatan ', 'Kec. '], '', $kec->nama)) == strtoupper($kecamatan) || $kec->nama == $kecamatan) ? 'selected' : ''); ?>><?php echo e($kec->nama); ?></option>
        ...
        <div class="filter-group">
            ...
            <select name="jenis_layanan" class="filter-select" onchange="this.form.submit()">
                <option value="-- Semua --" <?php echo e($jenis_layanan == '-- Semua --' ? 'selected' : ''); ?>>Semua Layanan</option>
                <option value="KTP-el" <?php echo e($jenis_layanan == 'KTP-el' ? 'selected' : ''); ?>>KTP-el</option>
                <option value="KIA" <?php echo e($jenis_layanan == 'KIA' ? 'selected' : ''); ?>>KIA</option>
                <option value="IKD" <?php echo e($jenis_layanan == 'IKD' ? 'selected' : ''); ?>>IKD</option>
            </select>
        </div>
        <div class="filter-group">
            <span class="filter-label">Status</span>
            <select name="status_pengajuan" class="filter-select" onchange="this.form.submit()">
                <option value="-- Semua --" <?php echo e($status_pengajuan == '-- Semua --' ? 'selected' : ''); ?>>Semua Status</option>
                <option value="Menunggu Verifikasi" <?php echo e($status_pengajuan == 'Menunggu Verifikasi' ? 'selected' : ''); ?>>Menunggu Verifikasi</option>
                <option value="Terverifikasi" <?php echo e($status_pengajuan == 'Terverifikasi' ? 'selected' : ''); ?>>Terverifikasi</option>
                <option value="Terjadwal" <?php echo e($status_pengajuan == 'Terjadwal' ? 'selected' : ''); ?>>Terjadwal</option>
                <option value="Selesai" <?php echo e($status_pengajuan == 'Selesai' ? 'selected' : ''); ?>>Selesai</option>
                <option value="Ditolak" <?php echo e($status_pengajuan == 'Ditolak' ? 'selected' : ''); ?>>Ditolak</option>
            </select>
        </div>
        
        <div class="action-buttons">
            <a href="<?php echo e(route('admin.laporan.download', request()->query())); ?>" target="_blank" class="btn btn-outline">
...
<div class="dashboard-grid">
    <div class="stat-card">
        ...
        <div class="stat-info">
            ...
            <span class="stat-value"><?php echo e(number_format($totalPengajuan ?? 1248)); ?></span>
        </div>
    </div>
    ...
    <div class="stat-card">
        ...
        <div class="stat-info">
            ...
            <span class="stat-value"><?php echo e(number_format($statTerverifikasi ?? 987)); ?></span>
        </div>
    </div>
    ...
    <div class="stat-card">
        ...
        <div class="stat-info">
            ...
            <span class="stat-value"><?php echo e(number_format($statTerjadwal ?? 654)); ?></span>
        </div>
    </div>
    ...
    <div class="stat-card">
        ...
        <div class="stat-info">
            ...
            <span class="stat-value"><?php echo e(number_format($statSelesai ?? 572)); ?></span>
        </div>
    </div>
        ...
        <div style="display: flex; align-items: center; justify-content: center; gap: 16px; width: 100%;">
            <div style="position: relative; width: 64px; height: 64px; flex-shrink: 0;">
                ...
                <div style="position: absolute; inset: 0; display: flex; flex-direction: column; align-items: center; justify-content: center; pointer-events: none;">
                    <span style="font-size: 0.95rem; font-weight: 800; color: var(--text-main); text-align: center;"><?php echo e($statSelesai ?? 572); ?></span>
                </div>
            </div>
            <div style="display: flex; flex-direction: column; gap: 4px; font-size: 0.7rem; flex-grow: 1;">
                <div style="display: flex; justify-content: space-between; gap: 6px;">
                    ...
                    <span style="color: var(--text-main); font-weight: 700;"><?php echo e(($statSelesai ?? 0) > 0 ? round((($rekapSelesaiData[0] ?? 0) / $statSelesai) * 100) : 0); ?>%</span>
                </div>
                <div style="display: flex; justify-content: space-between; gap: 6px;">
                    <div style="display: flex; align-items: center; gap: 4px;">
                    ...
                    <span style="color: var(--text-main); font-weight: 700;"><?php echo e(($statSelesai ?? 0) > 0 ? round((($rekapSelesaiData[1] ?? 0) / $statSelesai) * 100) : 0); ?>%</span>
                </div>
                <div style="display: flex; justify-content: space-between; gap: 6px;">
                    <div style="display: flex; align-items: center; gap: 4px;">
                    ...
                    <span style="color: var(--text-main); font-weight: 700;"><?php echo e(($statSelesai ?? 0) > 0 ? round((($rekapSelesaiData[2] ?? 0) / $statSelesai) * 100) : 0); ?>%</span>
                </div>
            </div>
        </div>
    </div>
...
<div class="main-grid">
    ...
    <div class="panel-box" style="overflow-x: auto;">
        ...
        <table class="data-table">
            ...
            <tbody>
                <?php $__currentLoopData = $paginatedDataLaporan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                    $rowClass = "";
                ...
                <tr class="<?php echo e($rowClass); ?>">
                    ...
                    <td style="<?php echo e($item['type'] == 'kelurahan' ? 'padding-left: 32px;' : ''); ?>"><?php echo e($item['wilayah']); ?></td>
                    <td>
                        <div style="font-weight: 600;"><?php echo e($item['tanggal']); ?></div>
                        <div style="font-size: 0.8rem; opacity: 0.8;"><?php echo e($item['keterangan']); ?></div>
                    </td>
                    <!-- IKD -->
                    <td style="border-left: 1px solid #e2e8f0; text-align: center;"><?php echo e(number_format($item['ikd_sudah'])); ?></td>
                    <td style="border-right: 1px solid #e2e8f0; text-align: center;"><?php echo e(number_format($item['ikd_belum'])); ?></td>
                    <!-- KTP -->
                    <td style="text-align: center;"><?php echo e(number_format($item['ktp_sudah'])); ?></td>
                    <td style="border-right: 1px solid #e2e8f0; text-align: center;"><?php echo e(number_format($item['ktp_belum'])); ?></td>
                    <!-- KIA -->
                    <td style="text-align: center;"><?php echo e(number_format($item['kia_sudah'])); ?></td>
                    <td style="text-align: center;"><?php echo e(number_format($item['kia_belum'])); ?></td>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </tbody>
        </table>
        ...
        <div style="margin-top: 24px;">
            <?php echo e($paginatedDataLaporan->links()); ?>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        new Chart(rekapCtx, {
            ...
            data: {
                ...
                datasets: [{
                    data: <?php echo json_encode($rekapSelesaiData ?? [0,0,0]); ?>,
...
<?php echo $__env->make('layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\jeboll\resources\views/admin/laporan.blade.php ENDPATH**/ ?>