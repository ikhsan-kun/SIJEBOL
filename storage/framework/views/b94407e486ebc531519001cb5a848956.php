...
<div class="custom-hero">
    ...
    <div class="hero-actions">
        ...
        <a href="<?php echo e(route('cabang.jadwal.create')); ?>" class="btn btn-warning" style="padding: 16px 24px; font-size: 1rem;">
...
<div class="filter-panel">
    <form method="GET" action="<?php echo e(route('cabang.jadwal') ?? '#'); ?>" class="filter-row">
