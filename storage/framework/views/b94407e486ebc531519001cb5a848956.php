...
<?php $__env->startSection('title', 'Jadwal Kegiatan Cabang - SI JEBOL'); ?>
...
<div class="hero-banner" style="display: flex; justify-content: space-between; text-align: left; align-items: center; flex-wrap: wrap; gap: 20px;">
    <div>
        ...
        <p>Manajemen Jadwal Lapangan <?php echo e(auth()->user()->kecamatan); ?></p>
    </div>
    <div style="display: flex; gap: 16px; align-items: center; z-index: 10;">
        <div style="background: rgba(255,255,255,0.1); backdrop-filter: blur(10px); padding: 12px 20px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.2); text-align: right; display: flex; flex-direction: column; justify-content: center;">
            <div style="font-size: 0.75rem; color: var(--accent); font-weight: bold; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 4px;"><?php echo e(now()->translatedFormat('l')); ?></div>
            <div style="font-size: 0.9rem; color: white; font-weight: 800; line-height: 1;"><?php echo e(now()->translatedFormat('d F Y')); ?></div>
        </div>
        <a href="<?php echo e(route('cabang.jadwal.create')); ?>" style="display: flex; align-items: center; gap: 8px; background: var(--accent); color: var(--primary-dark); padding: 16px 24px; border-radius: 12px; font-weight: 800; font-size: 0.9rem; text-decoration: none; box-shadow: 0 4px 15px rgba(245, 158, 11, 0.3); transition: all 0.2s;">
...
<!-- Filter Bar -->
<form method="GET" action="<?php echo e(route('cabang.jadwal')); ?>" class="filter-bar">
...
<div class="stats-grid">
    <div class="stat-card">
        ...
        <div class="stat-info">
            ...
            <h3 class="stat-value"><?php echo e(\App\Models\JadwalJebol::count()); ?></h3>
    ...
    <div class="stat-card">
        ...
        <div class="stat-info">
            ...
            <h3 class="stat-value"><?php echo e($activities->flatten()->count()); ?></h3>
            <p class="stat-sub"><?php echo e($monthName); ?></p>
        </div>
    </div>
    <div class="stat-card">
        ...
        <div class="stat-info">
            ...
            <h3 class="stat-value" style="font-size: 1.1rem; font-weight:800; margin-bottom:2px; margin-top:2px;"><?php echo e(Str::limit($nearest->lokasi ?? 'Belum ada jadwal', 20)); ?></h3>
            <p class="stat-sub"><?php echo e($nearest ? \Carbon\Carbon::parse($nearest->tanggal_pelayanan)->translatedFormat('d F Y') : '-'); ?></p>
        </div>
    </div>
    <div class="stat-card">
        ...
        <div class="stat-info">
            ...
            ?>
            <h3 class="stat-value"><?php echo e($selesai); ?></h3>
            <p class="stat-sub"><?php echo e($percentage); ?>% dari total</p>
        </div>
    </div>
</div>
...
<div class="bottom-grid">
    ...
    <div class="panel-card" id="calendar-panel">
        <div class="panel-header">
            <h3 class="panel-title">Kalender <?php echo e($monthName); ?> <?php echo e($currentDate->year); ?></h3>
        </div>
        <div class="cal-grid">
        ...
        <div class="schedule-list">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $upcoming; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $act): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="schedule-item" onclick="showCalDetail('<?php echo e($act->tanggal_pelayanan->format('Y-m-d')); ?>')">
                    ...
                    <div class="sch-detail"><i data-lucide="calendar" style="width:14px;"></i> <?php echo e($act->tanggal_pelayanan->format('d M Y')); ?></div>
                    <div class="sch-detail"><i data-lucide="clock" style="width:14px;"></i> <?php echo e(\Carbon\Carbon::parse($act->jam_mulai)->format('H.i')); ?> - <?php echo e(\Carbon\Carbon::parse($act->jam_selesai)->format('H.i')); ?> WIB</div>
...
<?php echo $__env->make('layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\jeboll\resources\views/cabang/jadwal.blade.php ENDPATH**/ ?>