                ...
                <div class="info-list">
                    ...
                    <div style="margin-top: 12px;">
                        ...
                        <div style="display: flex; flex-direction: column; gap: 12px;">
                            ...
                            <a href="<?php echo e(asset('storage/' . $permohonan->file_surat_pengantar)); ?>" target="_blank" style="display: flex; align-items: center; gap: 12px; padding: 12px 16px; border: 1px solid #e2e8f0; border-radius: 12px; text-decoration: none; color: inherit; background: white; transition: all 0.2s;">
                ...
                <div class="info-list">
                    <div class="info-grid">
                        <div class="info-row">
                            ...
                            <span class="info-value"><?php echo e($permohonan->masyarakat->no_hp ?? '-'); ?></span>
                        </div>
                        <div class="info-row">
                            <span class="info-label">Email</span>
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value"><?php echo e($permohonan->masyarakat->alamat ?? '-'); ?></span>
                    </div>
                    ...
                    <div style="margin-top: 12px;">
                        ...
                        <div style="display: flex; flex-direction: column; gap: 12px;">
                            ...
                            <a href="<?php echo e(asset('storage/' . $permohonan->file_ktp)); ?>" target="_blank" style="display: flex; align-items: center; gap: 12px; padding: 12px 16px; border: 1px solid #e2e8f0; border-radius: 12px; text-decoration: none; color: inherit; background: white; transition: all 0.2s;">
                            ...
                            <a href="<?php echo e(asset('storage/' . $permohonan->file_kk)); ?>" target="_blank" style="display: flex; align-items: center; gap: 12px; padding: 12px 16px; border: 1px solid #e2e8f0; border-radius: 12px; text-decoration: none; color: inherit; background: white; transition: all 0.2s;">
        ...
        <div class="panel-box">
            ...
            <?php else: ?>
                ...
                <div style="margin-bottom: 24px; border-top: 1px solid #e2e8f0; padding-top: 24px;">
                    ...
                    <div class="info-list">
                        <div class="info-grid">
                            <div class="info-row"><span class="info-label">NIK Anak</span><span class="info-value"><?php echo e($permohonan->nik_anak ?? '-'); ?></span></div>
                            <div class="info-row"><span class="info-label">Nama Anak</span><span class="info-value"><?php echo e($permohonan->nama_anak ?? '-'); ?></span></div>
                        </div>
            ...
            <div class="info-list">
                ...
                <div class="info-grid">
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value"><?php echo e($permohonan->tanggal_kedatangan ? \Carbon\Carbon::parse($permohonan->tanggal_kedatangan)->translatedFormat('d F Y') : '-'); ?></span>
                    </div>
                </div>
            </div>
        </div>
