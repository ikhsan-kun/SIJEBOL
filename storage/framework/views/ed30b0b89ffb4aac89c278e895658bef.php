                ...
                <div class="testimonials-grid">
                    <?php $__empty_1 = true; $__currentLoopData = $recentReviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="testimonial-card">
                            ...
                            <p class="testimonial-text">"<?php echo e(Str::limit($review->kritik_saran, 120)); ?>"</p>
                            <?php if($review->foto_path): ?>
                                <div style="margin-top: 15px; border-radius: 12px; overflow: hidden; max-height: 200px;">
                                    <img src="<?php echo e(Storage::url($review->foto_path)); ?>" alt="Foto Review" style="width: 100%; height: 100%; object-fit: cover; border-radius: 12px;">
                                </div>
                            <?php endif; ?>
                            <div class="testimonial-user">
                                ...
                                <div>
                                    ...
                                    <span style="display: flex; align-items: center; gap: 4px;">
                                        <?php for($i=1; $i<=5; $i++): ?>
                                            <i data-lucide="star" width="12" height="12" <?php echo e($i <= $review->nilai_kepuasan ? 'fill="#FFC107" color="#FFC107"' : 'color="#cbd5e1"'); ?>></i>
                                        <?php endfor; ?>
                                    </span>
                                </div>
                            </div>
        ...
        <section id="faq" class="faq">
            <div class="content-container">
                ...
                <div style="text-align: center; margin-top: 40px;">
                    <a href="<?php echo e(route('contact')); ?>" class="btn-testimoni">
