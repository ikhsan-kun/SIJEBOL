    ...
    <main>
        <section class="hero-premium jbl-1109 jbl-1293 jbl-1426">
            ...
            <div class="hero-slider">
                <!-- Slide 1 -->
                <div class="slide active" style="background-image: url('<?php echo e(asset('images/hero-slider-1.png')); ?>');">
                    <div class="content-container slide-content">
                        <div class="slide-text">
                            ...
                            <div class="hero-btns">
                                <a href="<?php echo e(route('services')); ?>" class="btn-premium">
                                    🚀 Lihat Layanan
                                </a>
                                <a href="<?php echo e(route('contact')); ?>" class="btn-glass">
                                    📞 Hubungi Kami
                                </a>
                            </div>
                        </div>
                ...
                <!-- Slide 2 -->
                <div class="slide" style="background-image: url('<?php echo e(asset('images/hero-slider-2.png')); ?>');">
                    <div class="content-container slide-content">
                        <div class="slide-text">
                            ...
                            <div class="hero-btns">
                                <a href="<?php echo e(route('jadwal')); ?>" class="btn-premium">📅 Cek Jadwal</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- Slide 3 -->
                <div class="slide" style="background-image: url('<?php echo e(asset('images/hero-slider-3.png')); ?>');">
                    <div class="content-container slide-content">
                        <div class="slide-text">
                ...
                <!-- Slide 4 -->
                <div class="slide" style="background-image: url('<?php echo e(asset('images/hero-slider-4.png')); ?>');">
                    <div class="content-container slide-content">
                        <div class="slide-text">
                            ...
                            <div class="hero-btns">
                                <a href="<?php echo e(route('services')); ?>" class="btn-premium">📂 Pilih Layanan</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- Slide 5 -->
                <div class="slide" style="background-image: url('<?php echo e(asset('images/hero-slider-5.png')); ?>');">
                    <div class="content-container slide-content">
                        <div class="slide-text">
                            ...
                            <div class="hero-btns">
                                <a href="<?php echo e(route('contact')); ?>" class="btn-premium">
        ...
        <div class="stats-float-wrapper">
            <div class="content-container">
                <div class="stats-float-card">
                    <div class="stat-box">
                        <span class="stat-num"><?php echo e($totalServices); ?></span>
                        <span class="stat-label">JENIS LAYANAN</span>
                    </div>
                    <div class="stat-box">
                        <span class="stat-num"><?php echo e($dokumenTerbit); ?></span>
                        <span class="stat-label">DOKUMEN TERBIT</span>
                    </div>
                    <div class="stat-box">
                        <span class="stat-num"><?php echo e($persenKepuasan); ?>%</span>
        ...
        <section id="layanan" class="features">
            <div class="content-container">
                ...
                <div style="text-align: center; margin-top: 48px;">
                    <a href="<?php echo e(route('services')); ?>" class="btn-testimoni">
        ...
        <section id="panduan" class="steps">
            <div class="content-container steps-content">
                <div class="steps-image">
                    <img src="<?php echo e(asset('images/steps.png')); ?>" alt="Administrative Process Flow">
                </div>
                ...
                <div class="premium-testimonials-grid">
                    <?php $__empty_1 = true; $__currentLoopData = $recentReviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="premium-testi-card">
                            <p class="premium-testi-text">"<?php echo e(Str::limit($review->kritik_saran, 120)); ?>"</p>
                            
                            <?php if($review->foto_path): ?>
                                <img src="<?php echo e(Storage::url($review->foto_path)); ?>" alt="Foto Review" class="premium-testi-img">
                            <?php endif; ?>
                            ...
                            <div class="premium-testi-user">
                                ...
                                <div class="premium-testi-info">
                                    <h4><?php echo e($review->masyarakat ? ($review->masyarakat->name ?? $review->masyarakat->nama) : 'Anonim'); ?></h4>
                                    <div class="premium-testi-stars">
                                        <?php for($i=1; $i<=5; $i++): ?>
                                            <i data-lucide="star" width="14" height="14" style="stroke: <?php echo e($i <= $review->nilai_kepuasan ? '#f59e0b' : '#cbd5e1'); ?>; fill: <?php echo e($i <= $review->nilai_kepuasan ? '#f59e0b' : '#f8fafc'); ?>;"></i>
                                        <?php endfor; ?>
                                    </div>
                                </div>
                            </div>
        ...
        <section id="faq" class="faq">
            <div class="content-container">
                ...
                <div style="text-align: center; margin-top: 40px;">
                    <a href="<?php echo e(route('bantuan')); ?>" class="btn-testimoni">
            ...
            <div class="content-container">
                <div class="cta-container">
                    ...
                    <div class="cta-actions">
                        ...
                        <a href="<?php echo e(route('bantuan')); ?>" class="btn btn-outline">Butuh Bantuan?</a>
                    </div>
                </div>
            </div>
        </section>
...
<?php /**PATH D:\laragon\www\jeboll\resources\views/pengunjung/beranda.blade.php ENDPATH**/ ?>