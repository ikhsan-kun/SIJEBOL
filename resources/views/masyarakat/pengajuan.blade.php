                    ...
                    <div class="form-card-modern transition-soft">
                        ...
                        <div class="form-grid">
                            <div>
                                ...
                                <input type="text" name="nama_sekolah" value="{{ auth()->user()->school }}" readonly class="form-input" style="background-color: #e2e8f0; cursor: not-allowed;" placeholder="Nama Sekolah">
                            </div>
                            <div>
                                <label class="form-label">Nama Petugas Penghubung (PIC) <span>*</span></label>
                                <input type="text" name="nama" value="{{ auth()->user()->nama ?? auth()->user()->name }}" required class="form-input" placeholder="Masukkan nama petugas sekolah">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="tel" name="phone" value="{{ auth()->user()->no_hp ?? auth()->user()->phone }}" required class="form-input" placeholder="08xxxxxxxxxx">
                            </div>
                            <div>
                        ...
                        @if(auth()->user() && auth()->user()->tipe_pendaftar === 'sekolah')
                            <div class="form-grid">
                                <div style="grid-column: span 2;">
                                    ...
                                    <small style="color: #64748b; font-size: 0.8rem; margin-top: 4px; display: block;">Format PDF atau Gambar, maksimal 2MB. <a href="{{ asset('templates/template_surat_pengantar_kolektif.rtf') }}" download style="color: #003178; font-weight: 700; text-decoration: underline;">Unduh Template Surat (Siap Cetak)</a></small>
                                </div>
                            </div>
                        @else
                            <div class="form-grid">
