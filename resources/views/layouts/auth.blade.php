...
<head>
    ...
    <title>@yield('title', 'Masuk') | SI JEBOL</title>
    ...
    <style>
        .auth-page {
            ...
            background-image: linear-gradient(rgba(0, 49, 120, 0.9), rgba(0, 49, 120, 0.8)), url('{{ asset('images/batik-tegal-premium.jpg') }}') !important;
        ...
        <div class="jbl-186 auth-shell auth-shell-single">
            <section class="auth-card">
                <div class="auth-card-header">
                    ...
                    <p>@yield('subtitle', 'Silakan masuk untuk mengakses layanan kependudukan Anda.')</p>
                </div>
