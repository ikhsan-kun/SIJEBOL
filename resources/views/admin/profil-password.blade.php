...
@section('title', 'Ubah Password - SI JEBOL Admin')
...
<div class="page-header">
    ...
    <div class="header-actions">
        <a href="{{ route('admin.profil') }}" class="btn btn-light-outline">
...
<div class="panel-box">
    ...
    <form action="{{ route('admin.profil.security') }}" method="POST">
        @csrf
        ...
        <div class="form-actions">
            <a href="{{ route('admin.profil') }}" class="btn btn-outline" style="border: 1px solid #cbd5e1; color: var(--text-main); background: white;">Batal</a>
