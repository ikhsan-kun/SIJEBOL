...
<div class="custom-hero">
    ...
    <div class="hero-actions">
        ...
        <a href="{{ route('admin.jadwal.create') }}" class="btn btn-warning" style="padding: 16px 24px; font-size: 1rem;">
...
<div class="filter-panel">
    <form method="GET" action="{{ route('admin.jadwal') }}" class="filter-row">
