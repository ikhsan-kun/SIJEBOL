...
@section('title', 'Profil Admin - SI JEBOL')
...
<div class="page-header">
    <div class="header-content">
        ...
        @else
            <img src="https://ui-avatars.com/api/?name={{ urlencode(auth()->user()->name) }}&background=f59e0b&color=ffffff&bold=true&size=200" alt="Avatar" class="profile-avatar-large">
        @endif
        <div>
            <h1 class="header-title">{{ auth()->user()->name }}</h1>
            <p class="header-subtitle">
                <i data-lucide="shield" style="width: 16px;"></i> {{ auth()->user()->jabatan ?? 'Admin Pusat' }}
            </p>
        </div>
    </div>
    <div class="header-actions">
        <a href="{{ route('admin.profil.edit') }}" class="btn btn-warning">
            <i data-lucide="edit-3" style="width: 18px;"></i> Ubah Profil
        </a>
        <a href="{{ route('admin.profil.password') }}" class="btn btn-light-outline">
            ...
            <div class="info-list">
                ...
                <div class="info-item">
                    ...
                    <div class="info-content">
                        ...
                        <div class="info-value">{{ auth()->user()->jabatan ?? 'Admin Pusat' }}</div>
                    </div>
                </div>
                ...
                <div class="info-item">
                    ...
                    <div class="info-content">
                        ...
                        <div class="info-value">{{ auth()->user()->alamat ?? 'Jl. Ki Gede Sebayu No. 12, Kota Tegal, Jawa Tengah 52122' }}</div>
                    </div>
                </div>
        ...
        <div class="panel-box">
            ...
            <div class="stat-card">
                ...
                <div class="stat-text">
                    ...
                    <div class="stat-val">{{ auth()->user()->role ?? 'Admin' }}</div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-text">
                    ...
                    <div class="stat-desc" title="{{ $lastLogin->user_agent ?? '' }}">Melalui {{ $loginDevice }}</div>
                </div>
            </div>
