...
@section('title', 'Tambah Jadwal Baru - SI JEBOL Admin')
...
<div class="page-header">
    ...
    <div class="header-actions">
        <a href="{{ route('admin.jadwal') }}" class="btn btn-light-outline">
...
<form action="{{ route('admin.jadwal.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="panel-box">
        ...
        <div class="form-actions">
            <a href="{{ route('admin.jadwal') }}" class="btn btn-outline" style="border: 1px solid #cbd5e1; color: var(--text-main); background: white;">Batal & Kembali</a>
