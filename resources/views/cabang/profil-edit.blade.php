...
@section('title', 'Edit Profil - SI JEBOL Admin')
...
<div class="panel-box">
    ...
    <form action="{{ route('cabang.profil.update') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-section">
            ...
            <div class="avatar-upload-container">
                @if(auth()->user()->foto_profil)
                    <img src="{{ asset('storage/' . auth()->user()->foto_profil) }}" alt="Avatar" class="avatar-preview" id="avatar_preview">
                @else
                    <img src="https://ui-avatars.com/api/?name={{ urlencode(auth()->user()->name) }}&background=003178&color=ffffff&bold=true" alt="Avatar" class="avatar-preview" id="avatar_preview">
                @endif
                <div>
        ...
        <div class="form-section">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="username" value="{{ auth()->user()->username }}" placeholder="{{ auth()->user()->name }}" class="form-control">
                </div>
                <div class="form-group">
                    <label class="form-label">Email *</label>
                    <input type="email" name="email" value="{{ auth()->user()->email }}" class="form-control" required pattern=".*@gmail\.com$" title="Harus menggunakan @gmail.com">
                </div>
                <div class="form-group">
                    <label class="form-label">Nomor Handphone</label>
                    <input type="text" name="phone" value="{{ auth()->user()->phone }}" placeholder="0812-3456-7890" class="form-control">
                </div>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <input type="text" name="jabatan" value="{{ auth()->user()->jabatan }}" placeholder="Admin Pusat" class="form-control">
            </div>
            <div class="form-group">
                <label class="form-label">Alamat Instansi</label>
                <textarea name="alamat" rows="3" placeholder="Jl. Ki Gede Sebayu No. 12, Kota Tegal, Jawa Tengah 52122" class="form-control">{{ auth()->user()->alamat }}</textarea>
            </div>
        </div>
