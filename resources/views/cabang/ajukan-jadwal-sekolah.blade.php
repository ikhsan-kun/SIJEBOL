...
@section('title', 'Ajukan Jadwal Sekolah - SI JEBOL')
...
<div class="form-header">
    <div class="form-title-wrap">
        ...
        <div>
            ...
            <p class="form-subtitle">{{ request('school') }}</p>
        </div>
    </div>
    <a href="{{ route('cabang.sekolah') }}" style="display: inline-flex; align-items: center; gap: 8px; background: rgba(255,255,255,0.2); color: white; padding: 10px 16px; border-radius: 8px; font-weight: 700; font-size: 0.85rem; text-decoration: none; backdrop-filter: blur(10px); border: 1px solid rgba(255,255,255,0.1);">
        <i data-lucide="arrow-left" style="width: 16px;"></i> Kembali
    </a>
</div>

<form action="{{ route('cabang.sekolah.ajukan_jadwal.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="card-panel">
        ...
        <div class="form-grid">
            <div class="field-group">
                ...
                <input type="text" name="lokasi" value="{{ request('school') }}" readonly class="field-input">
            </div>
            ...
            <div class="field-group">
                ...
                <input type="text" name="kecamatan" value="{{ $schoolInfo->kecamatan ?? '' }}" required placeholder="Contoh: Tegal Timur" class="field-input">
            </div>

            <div class="field-group">
                <span class="field-label">Desa / Kelurahan</span>
                <input type="text" name="desa" value="{{ $schoolInfo->kelurahan ?? '' }}" required placeholder="Contoh: Panggung" class="field-input">
            </div>

            <div class="field-group">
                <span class="field-label">Nama Kegiatan</span>
                <input type="text" name="nama_kegiatan" value="Jemput Bola - {{ request('school') }}" required class="field-input">
            </div>
    ...
    <div style="display: flex; justify-content: flex-end; gap: 16px; margin-bottom: 40px;">
        <a href="{{ route('cabang.sekolah') }}" class="btn-cancel">Batal & Kembali</a>
